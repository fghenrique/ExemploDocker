DROP DATABASE IF EXISTS concentrador;

CREATE DATABASE IF NOT EXISTS concentrador;

USE concentrador;

CREATE TABLE algoritmos_criptografia (
  tipo_cripto integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_cripto)
) ENGINE = innodb;
...
CREATE TABLE batimento_diario (
  data_movimento datetime not null,
  numero_loja int not null,
  numero_pdv int not null,
  codigo_tipo_movimento integer not null,
  qtde_movimentos int not null,
  vlr_movimento double(16,2) not null,
  vlr_cancelamento double(16,2) not null,
  PRIMARY KEY(data_movimento, numero_loja, numero_pdv, codigo_tipo_movimento)
) ENGINE = innodb;

CREATE TABLE batimento_movimentacao (
   data_movimento date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   valor_mapa_resumo double not null,
   valor_capa_cupom double not null,
   valor_detalhe_cupom double not null,
   valor_movimento_financeiro double not null,
   PRIMARY KEY(data_movimento, numero_loja, numero_pdv)
) ENGINE = innodb;

CREATE TABLE batimento_movimentacao_cupom (
   data_movimento date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   ...
   valor_detalhe_cupom double not null,
   valor_movimento_financeiro double not null,
   valor_diferenca double not null,
...
CREATE TABLE IF NOT EXISTS cad_ban_crt (
  ...
  rlz_bsc_ban_flh TINYINT(1) NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS cad_cli_cmd (
  cpf bigint not null ,
  rg varchar(10) not null ,
  nom varchar(40) not null ,
  edr varchar(40) not null ,
...
CREATE TABLE IF NOT EXISTS cad_cli_prm_fid (
  ...
  tip_cli INT(8) NOT NULL  DEFAULT 1  ,
  niv_prc INT(8) NOT NULL  ,
  PRIMARY KEY (cpf_cnpj)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cad_cmd (
  cpf bigint not null ,
  cmd int not null ,
  cod_prd_cvt bigint not null ,
  PRIMARY KEY(cpf, cmd)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS cad_grp_cmd (
  cod_loj INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cad_prf_csm (
  cod_loj INT NOT NULL ,
  cod_cpo INT NOT NULL ,
  cod_prf INT NOT NULL ,
  des VARCHAR(255) NOT NULL ,
  ord INT NOT NULL ,
  obr TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_loj, cod_cpo, cod_prf)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cad_prm_mix_acm (
  cod_loj INT NOT NULL ,
  dat_cad DATE NOT NULL ,
  cod_prd BIGINT NOT NULL ,
  dat_vig_ini DATE NOT NULL ,
  dat_vig_fim DATE NOT NULL ,
  prc_vig_acm DOUBLE(16,2) NOT NULL ,
  qtd_acm DOUBLE(16,2) NOT NULL ,
  qtd_est DOUBLE(16,2) NOT NULL ,
  dat_ult_alt DATE NOT NULL ,
  PRIMARY KEY (cod_loj, cod_prd, dat_cad, dat_vig_ini, dat_vig_fim, prc_vig_acm, qtd_acm)
)Engine = InnoDB
;
...
CREATE TABLE cad_set (
  cod_loj integer not null  ,
  cod_set integer not null  ,
  des VARCHAR(40) NOT NULL  ,
  PRIMARY KEY(cod_loj, cod_set)
) ENGINE = innodb
;
...
CREATE TABLE cadastro_comprovante (
  codigo integer not null,
...
CREATE TABLE cadastro_setor_balanca (
...
CREATE TABLE IF NOT EXISTS cam_lay_arq_bal (
  cod_loj INT NOT NULL,
  cod_lay INT NOT NULL,
  id_campo INT NOT NULL,
  tam INT NULL,
  ord INT NULL,
  PRIMARY KEY (cod_loj, cod_lay, id_campo)
)ENGINE = InnoDB
;
...
CREATE TABLE cat52_ecf_registros (
  id_sequencia integer not null,
  marca_ecf varchar(40) not null,
  modelo_ecf varchar(40) not null,
  identificacao_fabricante varchar(2) not null,
  codigo_modelo varchar(1) not null,
...
CREATE TABLE IF NOT EXISTS cfg_cam_cad_fid (
  grp INT NOT NULL ,
  ope INT NOT NULL ,
  cam INT NOT NULL ,
  obr TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (grp, ope, cam)
  )ENGINE = InnoDB
;
...
CREATE TABLE cfg_carga_prc_loj (
  cod_loj INT NOT NULL ,
  cod_niv INT NOT NULL ,
  PRIMARY KEY (cod_loj, cod_niv)
)ENGINE = InnoDB
;

CREATE TABLE cfg_cep (
  cod_ser INT(11) NOT NULL,
  chv VARCHAR(40) NOT NULL,
  hab tinyint(1) NOT NULL,
  tim INT(11) NOT NULL,
  cns_cep tinyint(1) NOT NULL,
  cns_end tinyint(1) NOT NULL,
  PRIMARY KEY (cod_ser)
) ENGINE = InnoDB;
...
CREATE TABLE cfg_cnv (
  ...
  apl_dsc_cvd_pgt TINYINT NOT NULL DEFAULT 0,
  idt_cnv_ino_vda TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (cod_loj)
)ENGINE = InnoDB
;

CREATE TABLE cfg_cnx_bco (
  tip integer not null , 
  chv integer not null ,
  tip_bco integer not null ,
  ip varchar(16) not null ,
  pta integer not null ,
  nom_bco varchar(255) not null ,
  usu varchar(100) not null , 
  sha varchar(100) not null , 
  ip_bkp varchar(16) not null ,
  pta_bkp integer not null ,
  PRIMARY KEY (tip, chv)
)ENGINE = innodb
;
...
CREATE  TABLE IF NOT EXISTS cfg_cpt_arq (
  cod_loj INT NOT NULL  ,
  tip_arq INT NOT NULL  ,
  cpt TINYINT NOT NULL DEFAULT 0  ,
  PRIMARY KEY (cod_loj, tip_arq)
 )ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_cpv_prm_cup (
	id_cpv INTEGER NOT NULL ,
	des_cpv VARCHAR(50) NOT NULL DEFAULT '' ,
	PRIMARY KEY(id_cpv)
)ENGINE = InnoDB
;
...
CREATE TABLE cfg_dad_adc_not (
  cod_loj INT(11) NOT NULL  ,
  id_cfg INT(11) NOT NULL  ,
  exb tinyint(1) not null default 0 ,
  vlr_txt VARCHAR(200) NULL  ,
  PRIMARY KEY (cod_loj, id_cfg)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_eml_fid (
  cod_loj INT NOT NULL ,
  arq_eml MEDIUMBLOB NOT NULL ,
...
CREATE TABLE cfg_etq_etr (
  cod_loj INT NOT NULL ,
  tip_int INT NOT NULL ,
  dir_ger VARCHAR(100) NOT NULL DEFAULT '' ,
  ip_ftp VARCHAR(20) NOT NULL DEFAULT '' ,
  usr_ftp VARCHAR(100) NOT NULL DEFAULT '' ,
  sha_ftp VARCHAR(100) NOT NULL DEFAULT '' ,
  dir_ftp varchar(100) not null default '' ,
  PRIMARY KEY(cod_loj, tip_int)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_exp_mov(
	cod_loj INTEGER(11) not null ,
	tip_exp INTEGER(11) not null ,
	tip_mov INTEGER(11) not null ,
	PRIMARY KEY (cod_loj,tip_exp,tip_mov)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_fun_ale (
  cod_loj INT NOT NULL DEFAULT 0 ,
  fnd INT NOT NULL ,
  cor INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cfg_ger_arq_xml(
    cod_loj INT NOT NULL ,
	tip INT NOT NULL ,
	gra_arq tinyint NOT NULL DEFAULT 0 ,
	cmh_gra_arq VARCHAR(255) NOT NULL ,
    env_arq_ftp tinyInt DEFAULT 0 NOT NULL ,
    dir_ftp VARCHAR(255) ,
	ip_ftp VARCHAR(255) ,
    pta_ftp INT ,
	usu_ftp VARCHAR(255) ,
	sha_ftp VARCHAR(255) ,
	cpc_arq tinyInt DEFAULT 0 NOT NULL ,
	sep_can tinyInt DEFAULT 0 NOT NULL ,
	cmh_gra_arq_can VARCHAR(255) NOT NULL ,
...
CREATE TABLE cfg_img_prp_ver_prc (
  cod_loj INT NOT NULL  ,
  nom_img VARCHAR(255) NOT NULL ,
  tpo INT NOT NULL  ,
  qtd_rpt INT NOT NULL  ,
  img MEDIUMBLOB not null  ,
  PRIMARY KEY (cod_loj, nom_img)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_imp_cli_rms (
  cod_loj INT NOT NULL ,
  hor_imp TIME NOT NULL ,
  dat_hor_ult_imp DATETIME ,
  PRIMARY KEY (cod_loj)
)Engine = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_imp_cli_rms_loj (
  cod_loj INT NOT NULL ,
  cod_loj_crg INT NOT NULL ,
  PRIMARY KEY (cod_loj, cod_loj_crg)
)Engine = InnoDB
;
...
CREATE  TABLE IF NOT EXISTS cfg_int_fca (
  tip_mov INT NOT NULL  ,
  agp_fin TINYINT NULL  ,
  cod_fin INT NULL  ,
  des VARCHAR(50) NULL  ,
  PRIMARY KEY (tip_mov)
 )ENGINE = InnoDB	
...
CREATE TABLE IF NOT EXISTS cfg_int_fca_fin (
 tip_mov INTEGER NOT NULL DEFAULT 0 ,
 cod_gra_fin INTEGER NOT NULL DEFAULT 0 ,
 cod_fin INTEGER NOT NULL DEFAULT 0 ,
 PRIMARY KEY (tip_mov, cod_gra_fin, cod_fin)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_int_fca_spn (
 tip_mov INTEGER NOT NULL DEFAULT 0 ,
 cod_gra_fin INTEGER NOT NULL DEFAULT 0 ,
 gra_tab TINYINT(1) NOT NULL DEFAULT 0 ,
 des VARCHAR(40) NOT NULL DEFAULT '' ,
 PRIMARY KEY (tip_mov, cod_gra_fin)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_int_fin_rms (
  cod_loj INT NOT NULL ,
  cod_fin INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cfg_int_usu_rms (
  cod_loj INT NOT NULL ,
  cod_usu INT NOT NULL ,
  cod_usu_rms INT NOT NULL ,
  PRIMARY KEY (cod_loj, cod_usu)
 )ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_lay_arq_txt (
  tip INT NOT NULL  ,
  id_tab INT NOT NULL  ,
  cam_tab VARCHAR(100) NOT NULL  ,
  ord INT NOT NULL  ,
  PRIMARY KEY (tip, id_tab, cam_tab)
 )
ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_lay_cmd_res (
  cod_Loj INT NOT NULL ,
  pos_x INT NOT NULL ,
  pos_y INT NOT NULL ,
  cod_cmd INT NOT NULL ,
  PRIMARY KEY (cod_Loj, pos_x, pos_y))
ENGINE = InnoDB
;
...
CREATE TABLE cfg_mod_ecn_loj (
  cod_loj INT NOT NULL  ,
  cod_mod INT NOT NULL ,
  des_mod VARCHAR(40) DEFAULT '' ,
  mod_crp BLOB not null ,
  PRIMARY KEY (cod_loj, cod_mod)
)ENGINE = InnoDB
;

CREATE  TABLE IF NOT EXISTS cfg_mod_vle_gas (
  cod_loj INT NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS cfg_msg_ale (
  cod_loj INT NOT NULL DEFAULT 0 ,
  tip_opr INT NOT NULL ,
  seq INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cfg_per_dsc_grp_prd (
	cod_loj INT NOT NULL DEFAULT 0 ,
	cod_grp INT NOT NULL DEFAULT 0 ,
...
CREATE  TABLE IF NOT EXISTS cfg_prd_mod_vle_gas (
  cod_loj INT NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS cfg_prt_ale (
  cod_loj INT NOT NULL DEFAULT 0 ,
...
CREATE TABLE IF NOT EXISTS cfg_prt_bd (
  id_int INT NOT NULL  ,
  modo INT NOT NULL  ,
  id_prt INT NOT NULL  ,
  vlr VARCHAR(80) NOT NULL  ,
  PRIMARY KEY (id_int, modo, id_prt)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_prt_loj_sat (
	...
	vrf_st_oper_sat TINYINT DEFAULT 1 NOT NULL ,
	exi_st_oper_sat TINYINT DEFAULT 0 NOT NULL ,
	...
	blq_cmc_sfz INT(8) DEFAULT 0 NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cfg_prt_pdv_nfc (
  ...
  imp_ite_can_cup TINYINT(1) NOT NULL DEFAULT 0 ,
...
CREATE TABLE IF NOT EXISTS cfg_res (
  ...
  qtd_dgi_etq integer ,
  imp_nao_cob_dez_por TINYINT(1) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS cfg_sct(
	...
	hab_som TINYINT not null default 0,
...
CREATE TABLE cfg_smf_imp_loj (
  cod_loj INT NOT NULL ,
  cod_cam INT NOT NULL ,
  des_cam VARCHAR(60) DEFAULT '' ,
  pos_cam INT NOT NULL ,
  tam_cam INT NOT NULL ,
  fmt_cam VARCHAR(20) DEFAULT '' ,
  PRIMARY KEY (cod_loj, cod_cam)
)ENGINE = InnoDB
;
...
CREATE TABLE cfg_thd_loj (
  cod_loj INT NOT NULL ,
  id_thd INT NOT NULL ,
  nom_thd VARCHAR(40) DEFAULT '' ,
  tem_ini_thd INT NOT NULL ,
  tem_rep_thd INT NOT NULL ,
  nro_cns_thd INT NOT NULL ,
  nro_reg_thd INT NOT NULL ,
  PRIMARY KEY (cod_loj, id_thd)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_txt_ban (
  ...
  ord INT NOT NULL  ,
  PRIMARY KEY (cod_ban, tip_crt, seq)
)ENGINE = InnoDB
;

CREATE  TABLE cfg_txt_cpv (
  cod_loj INT NOT NULL  ,
  tip_cpv INT NOT NULL  ,
  seq INT NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS cfg_wsv_lic(
  id_wsv INTEGER NOT NULL ,
  url_wsv VARCHAR(255) NOT NULL  ,
  hab TINYINT NOT NULL DEFAULT 0  ,
  PRIMARY KEY (id_wsv)
)ENGINE = innodb
...
CREATE  TABLE IF NOT EXISTS cli_atc (
  cpf_cnj BIGINT(20) NOT NULL  ,
  sit INT(11) NULL  ,
  ins_uf VARCHAR(14) NULL  ,
  nom VARCHAR(40) NULL  ,
  end VARCHAR(40) NULL  ,
  brr VARCHAR(20) NULL  ,
  cdd VARCHAR(20) NULL  ,
...
CREATE TABLE cliente_especifico (
  codigo_cliente integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(codigo_cliente)
) ENGINE = innodb;

CREATE TABLE IF NOT EXISTS cmd_ped_res (
  cod_loj INT NOT NULL ,
  cod_cmd INT NOT NULL ,
  cod_ped_atu BIGINT NOT NULL ,
  sit INT NOT NULL ,
...
CREATE TABLE comprovante_nao_fiscal(
  comprovante_nao_fiscal integer not null,
  descricao varchar(30) not null,
  PRIMARY KEY(comprovante_nao_fiscal)
) ENGINE = innodb;
...
CREATE TABLE conf_ger_pre_vendas (
  nome_arquivo varchar(100) not null,
  diretorio_arquivo varchar(100) not null,
...
CREATE TABLE config_exp_movimento_txt (
  id_integracao integer not null,
  formato_data_nome_arq varchar(20) not null default 'ddMMyyyy',
  formato_loja_nome_arq varchar(20) not null default '%d',
  formato_pdv_nome_arq varchar(20) not null default '%d',
  formato_cupom_nome_arq varchar(20) not null default '%d',
  formato_operador_nome_arq varchar(20) not null default '%d',
  formato_tipo_nome_arq varchar(20) not null default '%d',
  formato_seq_nome_arq varchar(20) not null default '%d',
  posicao_campos_nome_arq varchar(200) not null default 'NOME,_,DATA,_,LOJA,_,PDV,_,CUPOM,_,OPERADOR,_,TIPO,_,SEQUENCIA',
  conversao_naturaza_fiscal varchar(80) not null default 'F=F,I=I,N=N,T07=T07,T12=T12,T18=T18,T25=T25',
  nome_arquivo_generico varchar(80) not null,
  nome_arquivo_capa varchar(80) not null,
  nome_arquivo_detalhe varchar(80) not null,
  nome_arquivo_finalizadora varchar(80) not null,
  nome_arquivo_total_finalizadora varchar(80) not null,
  nome_arquivo_venda varchar(80) not null,
  nome_arquivo_mapa varchar(80) not null,
  nome_arquivo_saida_oper varchar(80) not null,
  nome_arquivo_recarga varchar(80) not null,
  nome_arquivo_corban varchar(80) not null,
  nome_arquivo_sangria varchar(80) not null,
  nome_arquivo_suprimento varchar(80) not null,
  nome_arquivo_sintegra varchar(80) not null,
  nome_arquivo_cartao varchar(80) not null,
  nome_arquivo_cheque varchar(80) not null,
  nome_arquivo_troca_mercadoria varchar(80) not null,
...
CREATE TABLE config_imp_cadastro (
  codigo_loja integer not null,
  enviar_email tinyint(1) not null default 0,
  email_log_anexo tinyint(1) not null default 0,
  gerar_log_reg_erro tinyint(1) not null default 0,
  formato_data_nome_arq varchar(40) not null default 'ddMM',
  posicao_campos_arq varchar(80) not null default 'LOJA,DATA,PONTO,NOME',
  conversao_natureza_fiscal varchar(100) not null default 'F=F,I=I,N=N,T07=T07,T12=T12,T18=T18,T25=T25',
  diferenciar_arq_txt_por_loja tinyint(1) not null default 0,
  utilizar_venda_peso_padrao tinyint(1) not null default 0,
  dif_dir_por_loj tinyint(1) not null default 0,
  apg_arq_imp tinyint(1) not null default 0 ,
  PRIMARY KEY(codigo_loja)
) ENGINE = innodb;

CREATE TABLE config_imp_cadastro_txt (
  id_integracao integer not null,
  id_tabela integer not null,
  opcao_carga integer not null,
  obrigatoria tinyint(1) not null default 0,
  PRIMARY KEY(id_integracao, id_tabela)
) ENGINE = innodb;
...
CREATE TABLE configuracao_balancas (
  codigo_loja integer not null,
  codigo_balanca integer not null,
  gerar_produto tinyint(1) not null default 1,
  gerar_setor tinyint(1) not null default 1,
  gerar_receitas tinyint(1) not null default 1,
  gerar_dados_nutricionais tinyint(1) not null default 1,
  caminho_geracao_arquivos varchar(200),
  gerar_por_codigo_ean tinyint(1) not null default 0,
  retirar_digito_verificador tinyint(1) not null default 0,
  PRIMARY KEY(codigo_loja, codigo_balanca)
) ENGINE = innodb; 
...
CREATE TABLE IF NOT EXISTS configuracao_cat52 (
  id integer not null,
  gerar_arquivo_automatico tinyint(1) not null default 0,
  gerar_arquivo_matriz tinyint(1) not null default 0,
  PRIMARY KEY(id)
) ENGINE = innodb;

CREATE TABLE configuracao_comanda_facil (
   numero_loja integer not null,
   ativo tinyint(1) not null default 1,
   url_ws_concentrador varchar(160) not null,
   url_ws_carga varchar(160) not null,
   url_ws_fechamento varchar(160) not null,
   tempo_sleep_servico bigint not null,
   rel_tex tinyint(1) not null default 0,
   rtt tinyint(1) not null default 0,
   ip_pdv varchar(20) not null,
   nvl_prc integer null default 0,
   utl_blc tinyint(1) not null default 0,
   nao_utl_prm_loj tinyint(1) not null default 0 ,
   exp_ean tinyint(1) not null default 0 ,
   PRIMARY KEY(numero_loja)
) ENGINE = INNODB;
...
CREATE TABLE configuracao_emissao_etiqueta (
  codigo_loja integer not null,
  data_hora_emissao_etiqueta datetime,
  emitir_alerta_conc tinyint(1) not null default 0,
  PRIMARY KEY(codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE configuracao_relatorio (
    id integer not null default 1,
	nome_empresa varchar(50) default '',
	percentual_visualizacao double(8,2) not null default 100,
	PRIMARY KEY(id)
) ENGINE = innodb;
...
CREATE TABLE configuracao_servico_autorizacao (
  id_servico integer not null,
  nome_servico varchar(40) not null,
  ativo tinyint(1) not null default 0,
  porta integer not null,
  driver_jdbc varchar(80) not null default '',
  url_jdbc varchar(200) not null default '',
  usuario_bd varchar(20) not null default '',
  senha_bd varchar(20) not null default '',
  tipo integer not null,
  PRIMARY KEY (id_servico)
) ENGINE = innodb;

CREATE TABLE configuracao_servico_conc (
  codigo_loja integer not null,
  prior_thread_conc integer not null,
  sleep_thread_conc long not null,
  prior_thread_imp_mov integer not null,
  sleep_thread_imp_mov long not null,
  prior_thread_exp_mov integer not null,
  sleep_thread_exp_mov long not null,
  prior_thread_mon_serv integer not null,
  sleep_thread_mon_serv long not null,
  PRIMARY KEY(codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE configuracao_verificador_preco_loja (
  numero_loja integer not null,
  codigo_hardware integer not null,
  ativo tinyint(1) not null default 0,
  diretorio_exportacao varchar(200) not null default '',
  nome_arquivo_exportacao varchar(40) not null default '',
  PRIMARY KEY(numero_loja, codigo_hardware)
) ENGINE = INNODB;
...
CREATE TABLE controle_campos_tela (
  id_tela INT NOT NULL ,
  id_campo INT NOT NULL ,
  nome_campo VARCHAR(40) NOT NULL ,
  obrigatorio TINYINT(1)  NULL ,
  tipo_campo INT NULL ,
  tamanho INT NULL ,
  id_validador INT NULL ,
  PRIMARY KEY (id_tela, id_campo)
)ENGINE = InnoDB
; 

CREATE TABLE controle_carga_auto (
  numero_loja integer not null,
  hora_carga time not null,
  ...
  carga_parcial integer not null,
  data_ultima_carga datetime,
  carga_somente_conc tinyint(1) not null default 0,
  periodo_tempo_carga integer not null default 0,  
  PRIMARY KEY(numero_loja)
) ENGINE = innodb;

CREATE TABLE controle_carga_comanda_facil (
   numero_loja integer not null,
   carga_produto_pendente tinyint(1) not null default 0,
   ultima_carga_produto datetime, 
   carga_usuario_pendente tinyint(1) not null default 0,
   ultima_carga_usuario datetime,
   PRIMARY KEY(numero_loja)
) ENGINE = INNODB;

CREATE TABLE controle_carga_conc (
  data_carga date not null,
  numero_loja integer not null,
  numero_pdv integer not null,  
  ...
  lib_rsv tinyint(1) not null default 0,
  PRIMARY KEY(data_carga, numero_loja, numero_carga)
) ENGINE = innodb;

CREATE TABLE controle_carga_loja_pdv (
  numero_loja integer not null,
  numero_pdv integer not null,
  data_hora_ultima_carga datetime,
  data_ultima_carga_produto date,
  PRIMARY KEY(numero_loja, numero_pdv)
) ENGINE = innodb;

CREATE TABLE controle_carga_micro_terminal (
  numero_loja integer not null,
  numero_carga integer not null,
  data_carga date not null,
  hora_carga time not null,
  carga_pendente tinyint(1) not null default 0,
  sucesso_exportar tinyint(1) not null default 0,
  data_hora_exportacao datetime,
  PRIMARY KEY(numero_loja)
) ENGINE = INNODB;
...
CREATE TABLE IF NOT EXISTS controle_geracao_cat52 (
  data_movimento date not null,
  numero_loja integer not null,
  numero_pdv integer not null,
  numero_fabricacao varchar(20) not null default '',
  situacao_geracao integer not null default 0,
  PRIMARY KEY(data_movimento, numero_loja, numero_pdv)
) ENGINE = innodb;
...
CREATE TABLE controle_numero_nota_fiscal(
...
CREATE TABLE controle_troca_mercadoria_conc (
  codigo_loja integer not null,
  data datetime not null,
  pdv integer not null,
  cupom integer not null,
  codigo_produto bigint not null,
  quantidade_trocada double(16,3) not null,
  PRIMARY KEY (codigo_loja, data, pdv, cupom, codigo_produto)
) ENGINE = innodb;

CREATE TABLE controle_vasilhame (  
...
CREATE TABLE controle_versao_conc (
  numero_loja integer not null,
  ...
  codigo_erro integer not null default 0,
...
CREATE TABLE controle_voucher (
   data_movimento date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   numero_cupom integer not null,
   total double(16,2) not null,
   total_utilizado double(16,2) not null,
   cpf_cnpj bigint not null,
...
CREATE TABLE conversor_arquivo_txt (
  id_conversor integer not null,
  nome_conversor varchar(40) not null,
...
CREATE TABLE cot (
  ...
  sit_cot INT(11)  NOT NULL,
  PRIMARY KEY (cod_loj, cod)
) ENGINE = InnoDB;
...
CREATE TABLE crt_ems_etq (
  dat_prc DATE NOT NULL , 
  cod_prd bigint NOT NULL ,
  imp_etq TINYINT(1) NOT NULL DEFAULT 0 ,
  alt_prc TINYINT(1) NOT NULL DEFAULT 0 ,
  prc_ant DOUBLE NOT NULL ,
  prc_atu DOUBLE NOT NULL ,
  PRIMARY KEY (dat_prc, cod_prd)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cte_rpt_mov (
  ...
  PRIMARY KEY (dat_hor, num_loj)
)ENGINE=InnoDB
;

CREATE TABLE ctr_abr_pdv (
	dat_mov date not null ,
	cod_pdv INT NOT NULL DEFAULT 0 ,
	fch tinyint(1) not null default 0 ,
	hor_mov time not null ,
	cpt varchar(255) null ,
	PRIMARY KEY(dat_mov, cod_pdv)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_abr_pdv_loj (
  dat_mov date not null ,
  cod_loj INT NOT NULL DEFAULT 0 ,
  num_pdv INT NOT NULL DEFAULT 0 ,
  fch tinyint(1) not null default 0 ,
  PRIMARY KEY(dat_mov, cod_loj, num_pdv)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_abr_res (
  cod_loj INT NOT NULL ,
  dat_abr TIMESTAMP NOT NULL ,
  pdv_abr INT NOT NULL ,
  PRIMARY KEY (cod_loj)
)ENGINE = InnoDB
;
...
CREATE TABLE ctr_atu_est_dia (
	dat_mov date not null ,
	hor_atu datetime not null ,
	cod_pdv INT NOT NULL DEFAULT 0 ,
...
CREATE TABLE ctr_atu_fid (
  ult_dta TIMESTAMP not null ,
  clo int not null ,
  PRIMARY KEY(ult_dta)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS ctr_aux_cup (
	num_cup BIGINT not null default 0 ,
	tip_cup INTEGER not null default 0 ,
	ipr TINYINT(1) not null default 0 ,
	PRIMARY KEY (num_cup,tip_cup)
)ENGINE = InnoDB
;

CREATE  TABLE IF NOT EXISTS ctr_cad_bio_cli (
  dat_alt DATETIME NOT NULL  ,
  cpf BIGINT NOT NULL  ,
  cod_loj INT NOT NULL  ,
  cod_usu INT NOT NULL  ,
  ori_atu INT NOT NULL  ,
  tip_atu INT NULL  ,
  PRIMARY KEY (dat_alt, cpf)
 )ENGINE = InnoDB
;

CREATE  TABLE IF NOT EXISTS ctr_cad_ptp_trn (
  dat_alt DATETIME NOT NULL  ,
  cod_ptp INT NOT NULL  ,
  cod_cam_alt INT NOT NULL  ,
  vlr_ant_cam VARCHAR(255) NOT NULL  ,
  cod_usu INT NOT NULL  ,
  PRIMARY KEY (dat_alt, cod_cam_alt, cod_ptp)
 )
ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_crg_imp (
  cod_loj INT NOT NULL  ,
  tip_imp INT NOT NULL  ,
  rem TINYINT(1) NOT NULL  ,
  dat_atz DATETIME ,
  PRIMARY KEY (cod_loj, tip_imp)
)ENGINE = InnoDB
;

CREATE TABLE ctr_crg_int (
  cod_loj integer not null ,
  tip_int integer not null ,
  num_crg integer not null ,
  dat_crg date not null ,
  hor_crg time not null ,
  crg_pen tinyint(1) not null default 0 ,
  suc_exp tinyint(1) not null default 0 ,
  dat_hor_exp datetime ,
  PRIMARY KEY(cod_loj, tip_int)
) ENGINE = INNODB
;

CREATE TABLE ctr_crg_wsv (
  cod_loj integer not null  ,
  num_crg integer not null  ,
  dat_crg date not null  ,
  hor_crg time not null  ,
  ...
  suc_exp tinyint(1) not null default 0  ,
  dat_hor_exp datetime  ,
  tip_wsv integer not null  ,
  PRIMARY KEY(cod_loj)
) ENGINE = INNODB
;

CREATE TABLE IF NOT EXISTS ctr_cta_ped (
  cod_ped bigint(20) NOT NULL ,
  coo_cnf_msa INT NOT NULL DEFAULT 0 ,
  ecf_cnf_msa INT NOT NULL DEFAULT 0 ,
  coo_fsc INT NOT NULL DEFAULT 0 ,
  ecf_fsc INT NOT NULL DEFAULT 0 ,
  cpt VARCHAR(255) ,
  PRIMARY KEY (cod_ped)
) ENGINE=InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_cup_can(
	dat DATE NOT NULL ,
	loj INT NOT NULL ,
	pdv INT NOT NULL ,
	cup INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS ctr_ems_not (
  dat_ems DATE NOT NULL ,
  cod_loj INT NOT NULL DEFAULT 0 ,
  tip_not INT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (dat_ems, cod_loj, tip_not)
) ENGINE=InnoDB
;

CREATE TABLE ctr_env_arq (
	dat_mov date not null ,
	cod_loj INT NOT NULL DEFAULT 0 ,
	seq INT NOT NULL DEFAULT 0 ,
	tip_arq INT NOT NULL DEFAULT 0 ,
	...
	nom_arq VARCHAR(255) NOT NULL DEFAULT '' ,
    ip_ftp VARCHAR(20) NOT NULL DEFAULT '' ,
	sit_env INT NOT NULL DEFAULT 0 ,
	PRIMARY KEY(dat_mov, cod_loj, seq)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_est_prm_mix_acm (
  dat_mov DATE NOT NULL ,
  cod_loj INT NOT NULL ,
  num_pdv INT NOT NULL ,
  num_cup INT NOT NULL ,
  ...
  dat_cad DATE NOT NULL ,
  cod_prd BIGINT NOT NULL ,
  qtd_rsv DOUBLE(16,3) NOT NULL ,
  sit int NOT NULL ,
  prc double(16,2) NOT NULL ,
  PRIMARY KEY (cod_loj, dat_cad, cod_prd, seq)
)Engine = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_exp_arq_nfc (
  num_loj INT NOT NULL  ,
  num_nfc INT NOT NULL  ,
  sre_nfc INT NOT NULL  ,
  sit INT NOT NULL  ,
  PRIMARY KEY (num_loj, num_nfc, sre_nfc)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_exp_arq_sat (
  num_loj INT NOT NULL  ,
  num_pdv INT NOT NULL  ,
  num_sre_hdw BIGINT NOT NULL ,
  num_cfe INT NOT NULL  ,
  sit INT NOT NULL  ,
  PRIMARY KEY (num_loj, num_pdv, num_sre_hdw, num_cfe)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_fec_num_nfc (
 dat DATE NOT NULL ,  
 loj INT NOT NULL ,
 pdv INT NOT NULL ,
 num INT NOT NULL ,
 PRIMARY KEY (dat, loj, pdv)
)ENGINE = InnoDB
;

CREATE TABLE ctr_imp_etq (
  cod_loj INT NOT NULL  ,
  cod_ean BIGINT NOT NULL  ,
  epd_etq TINYINT(1) NOT NULL DEFAULT 0  ,
  ems_etq TINYINT(1) NOT NULL DEFAULT 0  ,
  dat_hor_ems DATETIME NULL  ,
  PRIMARY KEY (cod_loj, cod_ean )
) ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_ips_ped_res (
  cod_ped BIGINT NOT NULL ,
  cod_cmd INT NOT NULL ,
  dat_hor_ips DATETIME ,
  sit INT NOT NULL DEFAULT 0 ,
  tip_ips INT NOT NULL ,
  PRIMARY KEY (cod_ped)
)Engine = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_lib_lic (
  cod_loj integer not null ,
  ctr_lic varchar(255) ,
  PRIMARY KEY(cod_loj)
) ENGINE = INNODB
...
CREATE TABLE IF NOT EXISTS ctr_pdv_lib (
  cod_loj INT NOT NULL  ,
  num_pdv INT NOT NULL  ,
  cpt VARCHAR(255) NULL  ,
  PRIMARY KEY (cod_loj, num_pdv)
...
CREATE TABLE IF NOT EXISTS ctr_prd_dav (
  dat_alt DATETIME NOT NULL  ,
  cod_loj INT NOT NULL  ,
  ...
  qtd DOUBLE NOT NULL  ,
  und VARCHAR(2) NOT NULL  ,
  val DOUBLE NOT NULL  ,
  dsc DOUBLE NULL  ,
  acr DOUBLE NULL  ,
  val_tot_liq DOUBLE NOT NULL  ,
  sit_trb VARCHAR(1) NOT NULL  ,
  alq INT NOT NULL  ,
  sit INT NOT NULL  ,
  tip_alt INT NOT NULL  ,
  cod_usu INT NOT NULL  ,
  cpt VARCHAR(650) ,
  PRIMARY KEY (dat_alt, cod_loj, cod_dav, seq)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_prm_mix_acm (
  cod_loj INT NOT NULL ,
  seq INT NOT NULL ,
  dat_vig_ini DATE NOT NULL ,
  dat_vig_fim DATE NOT NULL ,
  cod_prd BIGINT NOT NULL ,
  prc_ant DOUBLE(16,2) NOT NULL ,
  prc_alt DOUBLE(16,2) NOT NULL ,
  dat_hor_alt DATE NOT NULL ,
  usu INT NOT NULL ,
  nom_usu VARCHAR(20) ,
  loc_alt VARCHAR(50) ,
  dat_cad_prm DATE NOT NULL ,
  tip_alt int NOT NULL ,
  PRIMARY KEY (cod_loj, seq)
)Engine = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_sha_pdv (
   cod_loj INT NOT NULL  ,
   sha INT NOT NULL  ,
   dat DATE NOT NULL ,
   qtd_dgi_sha INT NOT NULL ,
   PRIMARY KEY(cod_loj)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_vas_aux (
	cod_cpv_vas BIGINT(14) NOT NULL ,
	cod_cpv_ori BIGINT(14) NOT NULL ,
	PRIMARY KEY (cod_cpv_vas,cod_cpv_ori)
)ENGINE = InnoDB
;

CREATE TABLE cupom_adicional_pre_venda (
  codigo_loja integer not null,
  codigo_pre_venda bigint not null,
  sequencia integer not null,
  linha_cupom varchar(40) not null,
  PRIMARY KEY (codigo_loja, codigo_pre_venda, sequencia)
) ENGINE = innodb;

CREATE TABLE dad_ctb (
  cod_loj INT NOT NULL  ,
  cpf_ctd BIGINT NOT NULL ,
  nom_ctd VARCHAR(60) DEFAULT '' ,
  num_crc VARCHAR(20) DEFAULT '' ,
  cnpj_ecr BIGINT not null ,
  cep VARCHAR(10) DEFAULT '' ,
  end VARCHAR(100) DEFAULT '' ,
  num INT NOT NULL ,
  cpl VARCHAR(100) DEFAULT '' ,
  bro VARCHAR(100) DEFAULT '' ,
  fon VARCHAR(12) DEFAULT '' ,
  fax VARCHAR(12) DEFAULT '' ,
...
CREATE TABLE dav  (
   codigo_loja  INT NOT NULL  ,
   codigo_dav  BIGINT NOT NULL  ,
   data  DATETIME NOT NULL  ,
   situacao  INT NULL DEFAULT 0  ,
   desconto_itens  DOUBLE(16,2) NULL DEFAULT 0  ,
   total_bruto  DOUBLE(16,2) NULL DEFAULT 0  ,
   total_liquido  DOUBLE(16,2) NULL DEFAULT 0  ,
   num_ecf  INT NOT NULL  ,
   cpf_cnp  BIGINT NOT NULL  ,
   nom_cli  VARCHAR(45) NOT NULL  ,
   coo_imp  INT NOT NULL  ,
   coo_vda  INT NOT NULL  ,
   tit_dav  INT NOT NULL  ,
   cod_ven  INT NOT NULL  ,
   cod_cnv  VARCHAR(16) NULL  ,
   cod_cvd  VARCHAR(20) NULL  ,
   cod_bin  BIGINT NULL  ,
   cod_cli  BIGINT NULL  ,
   rg  BIGINT NULL  ,
   end  VARCHAR(40) NULL  ,
   ...
   dat_imp DATETIME NULL  ,
   cod_fin_dav VARCHAR(100) NULL  ,
   cod_cnl INTEGER NOT NULL DEFAULT 0,
   num_pdv INTEGER NOT NULL DEFAULT 0,
  PRIMARY KEY ( codigo_loja ,  codigo_dav )
)ENGINE = InnoDB;
...
CREATE TABLE detalhe_cupom_venda (
   ...
   usuario_cancelou int not null,
   motivo_cancelamento int not null,
   cartao_presente tinyint(1) not null default 0,
...
CREATE TABLE duplicatas_receber (
     ...
     tipo_calculo_juros integer not null,
...
CREATE TABLE e13_detalhe_reducao_z (
   ...
   numero_fabricacao varchar(30) not null,
   contador_reducao_z integer not null,
   totalizador_parcial varchar(7) not null,
   mf_adicional varchar(1) not null,
   modelo_ecf varchar(20) not null,
   numero_usuario integer not null,
...
CREATE TABLE embalagem (
  embalagem varchar(2) not null,
  descricao varchar(20) not null,
  PRIMARY KEY(embalagem)
) ENGINE = innodb;
...
CREATE TABLE fin_dav (
  cod_loj int(11) NOT NULL ,
  cod_dav BIGINT NOT NULL ,
  seq int(11) NOT NULL ,
  fin int(11) NOT NULL ,	
  val double(16,2) NOT NULL ,
  num_par int(11) DEFAULT '0' ,
  jur int(11) DEFAULT '0' ,
  PRIMARY KEY (cod_loj,cod_dav,seq)
) ENGINE=InnoDB 
;
...
CREATE TABLE forma_pagto_pre_venda (
  codigo_loja integer not null,
  codigo_pre_venda bigint not null,
  sequencia integer not null,
  grupo_pagamento integer not null,
  codigo_finalizadora integer not null,
  ...
  cartao_convenio_contrato varchar(60) not null,
...
CREATE TABLE IF NOT EXISTS frc_res_dps (
  cod_loj INT NOT NULL ,  
  cod_cpo INT NOT NULL ,
  qtd_frc INT NOT NULL ,
  des VARCHAR(255) NOT NULL ,
  dat_ult_atu TIMESTAMP ,
  ina TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_loj,cod_cpo, qtd_frc)
) ENGINE=InnoDB
;
...
CREATE TABLE funcao_finalizadora (
...
CREATE TABLE grd_nat_uf (
  grd INT NOT NULL ,
  des VARCHAR(20) NOT NULL DEFAULT '' ,
  uf_ori VARCHAR(2) NOT NULL DEFAULT '' ,
  uf_dst VARCHAR(2) NOT NULL DEFAULT '' ,
  nat_ori VARCHAR(3) NOT NULL DEFAULT '' ,
  nat_dst VARCHAR(3) NOT NULL DEFAULT '' ,
  PRIMARY KEY(grd)
)ENGINE = InnoDB
;
...
CREATE TABLE grp_cli_dsc (
  ...
  per_dsc DOUBLE(16,2) NULL  ,
  org_vda VARCHAR(20)  ,
  PRIMARY KEY (cod_loj, grp_prc, sec_prd)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS grp_usu_res (
  cod_loj INT NOT NULL ,
  cod_grp INT NOT NULL ,
  cod_usu INT NOT NULL ,
  dat_ult_atu TIMESTAMP ,
  ina TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_loj, cod_grp, cod_usu)
)ENGINE = InnoDB
;

CREATE TABLE grupo_carga_coordenada (
  codigo_loja integer not null,
  codigo_grupo integer not null,
  descricao_grupo varchar(40) not null,
  PRIMARY KEY(codigo_loja, codigo_grupo)
) ENGINE = innodb;
...
CREATE TABLE grupo_faixa_etaria(
	codigo_grupo INTEGER NOT NULL DEFAULT 0,
	idade_inicial INTEGER NOT NULL DEFAULT 0,
	idade_final INTEGER NOT NULL DEFAULT 0,
	cod_usr BIGINT NULL ,
	dat_alt timestamp null,
	nom_usr VARCHAR(50) null,
...
CREATE TABLE impressao_setor_comanda_facil (
   codigo_secao integer not null,
   impressora varchar(60) not null,
...
CREATE TABLE integracao_econect (
  codigo_integracao integer not null,
  tipo_integracao integer not null,
  descricao varchar(40) not null,
  PRIMARY KEY(codigo_integracao)
) ENGINE = innodb;
...
CREATE TABLE inventario_loja (
  ...
  PRIMARY KEY(data_inventario, numero_inventario, numero_loja)
) ENGINE = innodb;
...
CREATE TABLE ip_vader_elgin (
   codigo_loja integer not null,
   numero_pdv integer not null,
   numero_ip varchar(16),
   local varchar(30),
   primary key (codigo_loja, numero_pdv, numero_ip)
) ENGINE =  innodb; 
...
CREATE TABLE IF NOT EXISTS lay_arq_bal (
  cod_loj INT NOT NULL,
  cod_lay INT NOT NULL,
  des VARCHAR(50) NOT NULL,
  nom_arq VARCHAR(50) NOT NULL,
  loc_gra VARCHAR(255) NOT NULL,
  PRIMARY KEY (cod_loj, cod_lay)
)ENGINE = InnoDB
;

CREATE TABLE lay_etq_etr (
  cod_loj INT NOT NULL , 
  cod_lay INT NOT NULL ,
  des_lay VARCHAR(100) NOT NULL DEFAULT '' ,
  del VARCHAR(30) NOT NULL DEFAULT '' ,
  nom_arq VARCHAR(250) NOT NULL DEFAULT '' ,
  del_fim VARCHAR(30) NOT NULL DEFAULT '' ,
  nom_arq_ctr VARCHAR(100) NOT NULL DEFAULT '' ,
  nom_arq_ret VARCHAR(100) NOT NULL DEFAULT '' ,
  tip_lay INT NOT NULL DEFAULT 1 ,
  PRIMARY KEY (cod_loj, cod_lay)
) ENGINE = InnoDB
;

CREATE TABLE liberacao_loja (  
  codigo_loja integer not null,
...
CREATE TABLE link_rede_loja_pdv (
  numero_loja integer not null,
  numero_pdv integer not null,
  data_hora_atu datetime,
  link_rede tinyint(1) not null default 1,
  cod_msg_link integer not null default 0,
  PRIMARY KEY(numero_loja, numero_pdv)
) ENGINE = innodb;

CREATE TABLE log_funcao_conc(
	id integer not null,
	descricao varchar(150) not null,
	PRIMARY KEY(id)
) ENGINE = innodb;

CREATE TABLE log_funcao_pdv(
	id integer not null,
	descricao varchar(150) not null,
	PRIMARY KEY(id)
) ENGINE = innodb;

CREATE TABLE log_operacao_conc (
  data date not null, 
  sequencia integer not null,
  hora time not null,
  ...
  tipo_modificacao integer not null,
...
CREATE TABLE medicos (
  ...
  tipo_conselho_regional varchar(200) not null,
  estado varchar(200),
...
CREATE TABLE modalidade_campanha (
	codigo_modalidade integer not null,
	descricao_modalidade varchar(40),
	PRIMARY KEY(codigo_modalidade)
) ENGINE = innodb;

CREATE TABLE modelo_balanca (
  codigo integer not null,
  descricao varchar(100) not null,
  PRIMARY KEY(codigo)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS mov_cad_dep_cli (
  dat_mov DATE NOT NULL ,
  cod_loj INT NOT NULL ,
  seq INT NOT NULL ,
  cpf_cnp_tit BIGINT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS mov_cad_dep_cvd (
  dat_mov DATE NOT NULL ,
  cod_loj INT NOT NULL ,
  seq INT NOT NULL ,
  cod_cnv VARCHAR(16) NOT NULL ,
...
CREATE TABLE mov_cpt (
   tip_reg varchar(10),
   texto varchar(255),
   PRIMARY KEY(tip_reg, texto)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS mov_ite_vda_tec (
   dat_vda DATE NOT NULL,
   cod_loj INT NOT NULL,
   num_pdv INT NOT NULL,
   num_cup INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mov_tot_dia_pgt(
	dat_mov DATE NOT NULL ,
	cod_loj INTEGER NOT NULL ,
	num_pdv INTEGER NOT NULL ,
	cod_fin INTEGER NOT NULL ,
	tip_doc INTEGER NOT NULL DEFAULT 0 ,
	des_fin VARCHAR (20) NOT NULL ,
	vlr_tot DOUBLE NOT NULL DEFAULT 0 ,
	cpt  VARCHAR(500) NULL DEFAULT NULL  ,
	PRIMARY KEY (dat_mov,cod_loj,num_pdv,cod_fin,tip_doc)
)ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS movimento_autorizacao (
  id BIGINT NOT NULL AUTO_INCREMENT  ,
  ...
  data_hora DATETIME NOT NULL  ,
  numero_pdv int NOT NULL  ,
  id_autorizacao_integracao BIGINT NOT NULL  ,
  situacao int NOT NULL  ,
  login int NOT NULL  ,
  senha int NOT NULL  ,
  PRIMARY KEY (id)
...
CREATE TABLE movimento_finalizadora (
   ...
   pagamento_acumulado tinyint(1) not null default 0, 
   tipo_entrada tinyint(1) not null default 0,
   possibilita_estorno tinyint(1) not null default 0,
   ...
   cotacao_moeda_estrangeira double(16,2) not null,
...
CREATE TABLE IF NOT EXISTS not_fsc_etd(
    dat_etd DATE NOT NULL  ,
    cod_loj INTEGER(11) NOT NULL ,
    cod_prd BIGINT NOT NULL  ,
    des_prd VARCHAR(60) NOT NULL  ,
    emb VARCHAR(2) NOT NULL  ,
    qtd_emb DOUBLE NOT NULL  ,
    nat_fsc VARCHAR(3) NOT NULL  ,
    prc DOUBLE NOT NULL  ,
    qtd DOUBLE NOT NULL  ,
    emt TINYINT(1) NOT NULL DEFAULT 0  ,
    PRIMARY KEY (dat_etd,cod_loj,cod_prd)
)ENGINE = InnoDB
;

CREATE TABLE notif_reg_atendimento (
...
CREATE TABLE padrao_txt_pre_venda (
   codigo integer not null,
   descricao varchar(50) not null,
   PRIMARY KEY(codigo)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS pfl_pms_res_dsp (
 cod_pfl INT NOT NULL ,
 cod_pms INT NOT NULL ,
 dat_ult_atu TIMESTAMP NULL ,
 ina TINYINT(1) NOT NULL DEFAULT 0 ,
 PRIMARY KEY (cod_pfl, cod_pms)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS pms_res_dsp (
  cod_pms BIGINT NOT NULL ,
  des VARCHAR(255) NOT NULL ,
    sol_sup TINYINT NOT NULL ,
  dat_ult_atu TIMESTAMP ,
  ina TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_pms))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS pms_usr_res_dsp (
  cod_usr BIGINT NOT NULL ,
  cod_pms BIGINT NOT NULL ,
  dat_ult_atu TIMESTAMP ,
  ina TINYINT(1) NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_usr, cod_pms))
ENGINE = InnoDB
;
...
CREATE TABLE prd_cot (
  cod_loj INT(11) NOT NULL, 
  cod_cot INT(11) NOT NULL,
  cod_prd BIGINT NOT NULL,
  qtd DOUBLE(16,3) NOT NULL,
  PRIMARY KEY (cod_loj, cod_cot, cod_prd)
) ENGINE = InnoDB;
...
CREATE TABLE prd_ins (
  cod_loj INT NOT NULL  ,
  cod_prd INT NOT NULL ,
  cod_ite INT NOT NULL ,
  qtd double(10,3) DEFAULT 0 ,
  PRIMARY KEY (cod_loj, cod_prd, cod_ite)
)ENGINE = InnoDB
;
...
CREATE TABLE prd_med (
  cod_prd bigint NOT NULL ,
  pcp_atv VARCHAR(250) DEFAULT '' ,
  PRIMARY KEY (cod_prd)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS prd_res (
  cod_loj INT NOT NULL ,
  cod_cpo INT NOT NULL ,
  prd BIGINT NOT NULL ,
  des VARCHAR(255) NOT NULL ,
  ord INT NOT NULL ,
  PRIMARY KEY (cod_loj, cod_cpo, prd)
)ENGINE = InnoDB
;
...
CREATE TABLE pre_venda (
  ...
  codigo_pre_venda bigint not null,
  data datetime not null,
  codigo_convenio varchar(16) default '',
  codigo_conveniado varchar(20) default '',
  codigo_bin bigint default 0,
  situacao integer default 0,
  vendedor integer default 0,
  codigo_cliente bigint default 0,
  numero_cpf_cnpj varchar(16) default '',
  rg bigint default 0,
  ...
  cep bigint default 0,
  numero_pedido bigint not null default 0,
  tipo_operacao integer not null default 0,
  cod_fin_dav VARCHAR(100) NULL  ,
  num_rom BIGINT NULL,
  vlr_fte DOUBLE DEFAULT 0,
  acr DOUBLE NOT NULL DEFAULT 0,
  PRIMARY KEY (codigo_loja, codigo_pre_venda)
) ENGINE = innodb;

CREATE TABLE pre_venda_quarto (
  codigo_loja integer not null,
  codigo_pre_venda bigint not null,
...
CREATE TABLE preferencia(
	codigo_preferencia INTEGER NOT NULL DEFAULT 0,
	ordem_visualizacao INTEGER NOT NULL DEFAULT 0,
	pergunta VARCHAR(80),
	tipo_pergunta INTEGER NOT NULL DEFAULT 0,
	qtde_min_resp INTEGER NOT NULL DEFAULT 0,
	qtde_max_resp INTEGER NOT NULL DEFAULT 0,
	habilitada TINYINT(1) NOT NULL DEFAULT 0,
	cod_usr BIGINT NULL ,
	dat_alt timestamp null,
	PRIMARY KEY (codigo_preferencia),
	UNIQUE UQ_preferencias_key(ordem_visualizacao)
)ENGINE = innodb;

CREATE TABLE preferencia_consumo (
  codigo_preferencia integer not null,
  descricao varchar(40) not null,
  PRIMARY KEY(codigo_preferencia)
) ENGINE = INNODB;

CREATE TABLE preferencia_grupo(
	codigo_preferencia INTEGER NOT NULL DEFAULT 0,
	codigo_grupo INTEGER NOT NULL DEFAULT 0,
	PRIMARY KEY (codigo_preferencia, codigo_grupo)
)ENGINE = innodb;

CREATE TABLE preferencia_resposta(
	codigo_preferencia INTEGER NOT NULL DEFAULT 0,
	ordem_resposta INTEGER NOT NULL DEFAULT 0,
	resposta VARCHAR(80),
	PRIMARY KEY (codigo_preferencia, ordem_resposta)
)ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS prf_res_dsp (
  cod_loj INT NOT NULL ,
  cod_cpo INT NOT NULL ,
  cod_prf INT NOT NULL ,
  ord INT NOT NULL ,
  des VARCHAR(255) NOT NULL ,
  prc_adi DOUBLE NOT NULL ,
  prc_sub DOUBLE NOT NULL ,
  dat_ult_atu TIMESTAMP ,
  ina TINYINT NOT NULL DEFAULT 0 ,
  obr TINYINT NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_loj, cod_cpo, cod_prf, ord)
) ENGINE=InnoDB
;
...
CREATE TABLE IF NOT EXISTS prm_fid_aux (
  cod_prd bigint not null ,
  dta_ini date not null ,
  dta_fim date not null ,
  cod_loj integer not null ,
  cod_bin bigint not null ,
  cod_usu_cad integer ,
  nom_usu_cad VARCHAR(100) ,
  dta_cad datetime ,
  cod_usu_alt integer ,
  nom_usu_alt VARCHAR(100) ,
  dta_alt datetime default null ,
  prc_vig_cad double(16,2) not null ,
  PRIMARY KEY(cod_prd, dta_ini, dta_fim, cod_loj, cod_bin)
)ENGINE = InnoDB
;
...
CREATE TABLE produto_controlado_loja (
  codigo_produto bigint not null,
  codigo_loja int not null,
  data_atualizacao date not null,
...
CREATE TABLE produto_natureza_estado (
  codigo_produto bigint not null,
  codigo_natureza varchar(3) not null,
  sigla_estado varchar(2) not null,
  data_atualizacao date not null,
  PRIMARY KEY(codigo_produto, sigla_estado)
) ENGINE = innodb;

CREATE TABLE produto_preferencia_consumo (
   codigo_produto bigint not null,
   codigo_preferencia integer not null,
   PRIMARY KEY(codigo_produto, codigo_preferencia)
) ENGINE = INNODB;
...
CREATE TABLE produto_setor_balanca (
  codigo_loja integer not null,    
  codigo_produto bigint not null,
  codigo_setor integer not null,
  PRIMARY KEY(codigo_loja, codigo_produto)
) ENGINE = innodb;
...
CREATE TABLE produtos_dav  (
   codigo_loja  INT NOT NULL  ,
   codigo_dav  BIGINT NOT NULL  ,
   sequencia  INT NOT NULL  ,
   codigo_produto  BIGINT NOT NULL  ,
   preco_produto  DOUBLE(16,2) NULL DEFAULT 0  ,
   quantidade  DOUBLE(16,3) NULL DEFAULT 0  ,
   desc_percentual  DOUBLE(16,2) NULL DEFAULT 0  ,
   desc_valor  DOUBLE(16,2) NULL DEFAULT NULL  ,
   descricao  VARCHAR(50) NULL DEFAULT NULL  ,
   codigo_natureza  VARCHAR(3) NULL DEFAULT ''  ,
   situacao  INT NULL DEFAULT 0  ,
   total_bruto  DOUBLE(16,2) NULL DEFAULT 0  ,
   total_liquido  DOUBLE(16,2) NULL DEFAULT 0  ,
   dat_inc  DATETIME NULL DEFAULT NULL  ,
   emb  VARCHAR(2) NULL DEFAULT NULL  ,
   vlr_acr  DOUBLE(16,2) NULL DEFAULT NULL  ,
   vlr_aqt  DOUBLE(16,2) NULL DEFAULT NULL  ,
   crm  VARCHAR(50) NULL  ,
   tip_mdt  VARCHAR(2) NULL  ,
   lbr  VARCHAR(50) NULL  ,
   cpt  VARCHAR(600) NULL DEFAULT NULL  ,
   nom_mco VARCHAR(80) NOT NULL ,
   tip_csl_rgl VARCHAR(20) NOT NULL ,
   cod_lbr INTEGER DEFAULT 0 ,
   des_lbr VARCHAR(80) NOT NULL ,
   usu_alt_dsc INT NOT NULL  ,
   pbm tinyint(1) not null default 0,
   tip_dsc INT NOT NULL DEFAULT 0  ,
  PRIMARY KEY ( codigo_loja ,  codigo_dav ,  sequencia )
)ENGINE = InnoDB
;

CREATE TABLE produtos_pre_venda (
  codigo_loja integer not null,
  codigo_pre_venda bigint not null,
  sequencia integer not null,
  codigo_produto bigint not null,
  preco_produto double(16,2) default 0,
  quantidade double(16,3) default 0,
  desc_percentual double(16,2) default 0,
  desc_valor double(16,2) default 0,
  descricao varchar(50) default '',
  crm varchar(50)  default '',
  laboratorio varchar(50) default '',
  tipo_medicamento varchar(2) not null default '',
  codigo_natureza varchar(3) default '',
  cancelado_pdv tinyint(1) not null default 0,
  PRIMARY KEY (codigo_loja, codigo_pre_venda, sequencia, codigo_produto)
) ENGINE = innodb;
...
CREATE TABLE produtos_troca_conc (
  codigo_loja integer not null,
  codigo_troca bigint not null,
  data_troca datetime not null,
  codigo_produto bigint not null,
  preco_produto double(16,2) not null,
  quantidade double(16,3) not null,
  descricao varchar(50),
  codigo_motivo integer not null,
  codigo_embalagem bigint not null,
  PRIMARY KEY (codigo_loja, codigo_troca, data_troca, codigo_produto, codigo_embalagem)
) ENGINE = innodb;
...
CREATE TABLE qtd_produto_estoque (
  ...
  codigo_produto bigint not null,
  qtd_estoque double(16,3) not null,
  data_atualizacao date not null,
  subtrair_estoque tinyint(1) not null default 0,
...
CREATE TABLE retaguarda_especifica (
  codigo_retaguarda integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(codigo_retaguarda)
) ENGINE = innodb;
...
CREATE TABLE riach_financiamento (
  ...
  entrada_obrigatoria tinyint(1) not null default 0,
  entrada_minima double(16,2),
  entrada_maxima double(16,2),
...
CREATE TABLE riach_parametro (
  ...
  destaca_cupom tinyint(1) not null default 0,
  habilita_vendedor tinyint(1) not null default 0,
...
CREATE TABLE rodape_pre_venda (
  codigo_loja integer not null,
  codigo_pre_venda bigint not null,
  sequencia integer not null,
  msg_rodape varchar(40) not null,
  PRIMARY KEY (codigo_loja, codigo_pre_venda, sequencia)
) ENGINE = innodb;
...
CREATE TABLE sec_grp_sgr_prd_grd(
  sec INT NOT NULL  ,
  grp INT NOT NULL  ,
  sgr INT NOT NULL  ,
  prd BIGINT NOT NULL  ,
  grd INT NOT NULL  ,
  PRIMARY KEY (sec, grp, sgr, prd, grd)
) ENGINE = INNODB
;
...
CREATE TABLE IF NOT EXISTS seq_cph_pmo (
  cod_loj INT NOT NULL  ,
  seq_vda BIGINT NULL  ,
  PRIMARY KEY (cod_loj)
 )ENGINE = InnoDB
...
CREATE TABLE servico_autorizacao (
  id_servico integer not null,
  nome_servico varchar(40) not null,
  PRIMARY KEY (id_servico)
) ENGINE = innodb;

CREATE TABLE situacao_atual_pdv (
  codigo_loja integer not null,
  codigo_pdv integer not null,
  data_hora_situacao datetime default '0000-00-00 00:00:00',
  caixa_aberto tinyint(1) not null default 0,
  data_movimento date not null,
  situacao varchar(80) not null,
  PRIMARY KEY(codigo_loja, codigo_pdv)
) ENGINE = innodb;

CREATE TABLE situacao_pdv (
  situacao_pdv integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(situacao_pdv)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS tab_nut_pdr (
  cod_elm INT NOT NULL ,
  per_dia DOUBLE(16,2) NOT NULL ,
...
CREATE TABLE tabela_nutricional (
  ...
  unidade varchar(40),
  PRIMARY KEY(codigo_loja, codigo_produto, id_elementos)  
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_50 (
  data_emissao date not null,
  numero_nota integer not null,
  aliquota double(16,2) not null,
  cnpj_destino long not null,
  insc_estadual_destino varchar(14) not null,
  estado_destino varchar(2) not null,
  modelo_nota_fiscal int not null,
  serie_nota_fiscal varchar(3) not null,
  codigo_fiscal_operacao int not null,
  tipo_emitente varchar(1) not null,
  total_nota_fiscal double(16,2) not null,
  base_calculo_icms double(16,2) not null,
  valor_apurado_icms double(16,2) not null,
  valor_isento_nao_tributado double(16,2) not null,
  valor_outras double(16,2) not null,
  situacao_nota_fiscal double(16,2) not null,
  PRIMARY KEY(data_emissao, numero_nota, aliquota)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_53 (
  data_emissao date not null,
  numero_nota integer not null,
  aliquota double(16,2) not null,
  cnpj_destino long not null,
  ...
  base_calculo_icms double(16,2) not null,
  valor_apurado_icms double(16,2) not null,
  despesa_acessoria double(16,2) not null,
  situacao_nota_fiscal varchar(1) not null,
  PRIMARY KEY(data_emissao, numero_nota, aliquota)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_54 (
  data_emissao date not null,
  numero_nota integer not null,
  sequencial_item integer not null,
  cnpj_destino long not null,
  modelo_mota_fiscal int not null,
  serie_nota_fiscal varchar(3) not null,
  codigo_fiscal_operacao int not null,
  codigo_situacao_tributaria varchar(3) not null,
  codigo_produto bigint not null,
  quantidade double(16,3) not null,
  valor_bruto double(16,2) not null,
  valor_desconto double(16,2) not null,
  valor_baseCalculoIcms double(16,2) not null,
  valor_base_substituicao double(16,2) not null,
  valor_ipi double(16,2) not null,
  aliquota_icms double(16,2) not null,
  PRIMARY KEY(data_emissao, numero_nota, sequencial_item)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_60_d (
  data_emissao date not null,
  numero_serie varchar(20) not null,
  codigo_produto bigint not null,
  aliquota varchar(4) not null,
  sub_tipo varchar(1) not null,
  qtde_itens double(16,3) not null,
  valor_acumulado double(16,2) not null,
  valor_base_calculo double(16,2) not null,
  valor_apurado_icms double(16,2) not null,
  PRIMARY KEY(data_emissao, numero_serie, codigo_produto, aliquota)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_60_i (
  data_emissao date not null,
  numero_serie varchar(20) not null,
  numero_cupom integer not null,
  sequencia integer not null,
  ...
  aliquota varchar(4) not null,
  valor_apurado_icms double(16,2) not null,
  PRIMARY KEY(data_emissao, numero_serie, numero_cupom, sequencia)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_60_r (
  mes_ano_emissao varchar(6) not null,
  codigo_produto bigint not null,
  aliquota_icms varchar(4) not null,
  qtde_itens double(16,3) not null,
  valor_bruto_produto double(16,2) not null,
  valor_base_calculo_icms double(16,2) not null,
  PRIMARY KEY(mes_ano_emissao, codigo_produto, aliquota_icms)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_61 (
  data_emissao date not null,
  modelo integer not null,
  serie varchar(3) not null,
  subserie varchar(2) not null,
  numero_inicial integer not null,
  numero_final integer not null,
  valor_total double(13,2) not null,
  base_calculo double(13,2) not null,
  valor_icms double(13,2) not null,
  isento_nao_tributado double(13,2) not null,
  outras double(13,2) not null,
  aliquota double(13,2) not null,
  PRIMARY KEY(data_emissao, modelo, serie, subserie)
) ENGINE = innodb;

CREATE TABLE tabela_temp_sintegra_reg_61_r (
  mes_ano_emissao varchar(6) not null,
  codigo_produto bigint not null,
  aliquota_icms varchar(4) not null,
  qtde_itens double(16,3) not null,
...
CREATE TABLE tabela_temp_sintegra_reg_75 (
  codigo_produto bigint not null,
  codigo_mercosul varchar(8) not null,
  descricao_produto varchar(53) not null,
  unidade_medida varchar(6) not null,
  situaca_tributaria varchar(3) not null,
  aliquota_ipi double(16,2) not null,
  aliquota_icms double(16,2) not null,
  reducao_base double(16,2) not null,
  substituicao double(16,2) not null,
  PRIMARY KEY(codigo_produto)
) ENGINE = innodb;
...
CREATE TABLE tipo_campanha (
	tipo_campanha integer not null,
	desc_tipo_campanha varchar(40),
	PRIMARY KEY(tipo_campanha)
) ENGINE = innodb;

CREATE TABLE tipo_desconto (
  tipo_desconto integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_desconto)
) ENGINE = innodb;

CREATE TABLE tipo_finalizadora (
  tipo_finalizadora integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_finalizadora)
) ENGINE = innodb;

CREATE TABLE tipo_gateway (
  id_tipo_gateway int unsigned not null,
  descricao varchar(40) not null default '',
  PRIMARY KEY(id_tipo_gateway)
) ENGINE = innodb;
...
CREATE TABLE tipo_movimento_batimento (
  codigo_tipo_movimento integer not null,
  descricao varchar(100) not null,
  PRIMARY KEY(codigo_tipo_movimento)
) ENGINE = innodb;
...
CREATE TABLE tipo_promocao (
  tipo_promocao integer not null,
  descricao varchar(50) not null,
  PRIMARY KEY(tipo_promocao)
) ENGINE = innodb;

CREATE TABLE tipo_promocao_mix (
  tipo_prom_mix integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_prom_mix)
) ENGINE = innodb;
...
CREATE TABLE tipo_transacao (
  ...
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_transacao)
) ENGINE = innodb;

CREATE TABLE tipo_validacao_senha (
  tipo_validacao_senha integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_validacao_senha)
) ENGINE = innodb;

CREATE TABLE tipo_validacao_usu (
  tipo_validacao_usu integer not null,
  descricao varchar(20) not null,
  PRIMARY KEY(tipo_validacao_usu)
) ENGINE = innodb;
...
CREATE TABLE transacao (
   id integer not null default 1,
   codigo_loja integer not null default 0,
   chq_serasa_aci tinyint(1) not null default 0,
   chq_cons_tecban tinyint(1) not null default 0,
   chq_grt_tecban tinyint(1) not null default 0,
   chq_grt_papel_tecban tinyint(1) not null default 0,
   deb_vista tinyint(1) not null default 0,
   deb_pre_dat tinyint(1) not null default 0,
   deb_parc tinyint(1) not null default 0,
   deb_cdc tinyint(1) not null default 0,
   deb_refc_eletro tinyint(1) not null default 0,
   cre_vista tinyint(1) not null default 0,
   cre_parc_fin_est tinyint(1) not null default 0,
   cre_parc_fin_adm tinyint(1) not null default 0,
   cre_digitado tinyint(1) not null default 0,
   pre_autorizacao tinyint(1) not null default 0,
   cartao_fininvest tinyint(1) not null default 0,
   cre_pro_rata_vist tinyint(1) not null default 0,
   cre_pro_rata_parc tinyint(1) not null default 0,
   cre_cons_parc tinyint(1) not null default 0,
   canc_cre_deb tinyint(1) not null default 0,
   pag_conta tinyint(1) not null default 0,
   estorno_pag_conta tinyint(1) not null default 0,
   reimpr_pag_conta tinyint(1) not null default 0,
   pag_benef tinyint(1) not null default 0,
   estorno_pag_benef tinyint(1) not null default 0,
   trat_troco_pag_conta_din tinyint(1) not null default 0,
   recrg_cel_din tinyint(1) not null default 0,
   recrg_cel_chq tinyint(1) not null default 0,
   recrg_cel_deb tinyint(1) not null default 0,
   recrg_cel_cre tinyint(1) not null default 0,
   menu_oper_recrg tinyint(1) not null default 0,
   PRIMARY KEY(id)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS trf_ite_res (
  num_ped_ori BIGINT NOT NULL ,
  num_ped_dtn BIGINT NOT NULL ,
  cod_prd BIGINT NOT NULL ,
  cmd_ori BIGINT NOT NULL ,
  cmd_dtn BIGINT NOT NULL ,
  des_prd VARCHAR(255) NOT NULL ,
  qtd DOUBLE NOT NULL ,
  prc DOUBLE NOT NULL ,
  dat_trf DATETIME NOT NULL ,
  cod_usu INTEGER NOT NULL ,
  PRIMARY KEY (num_ped_ori, num_ped_dtn, cod_prd))
ENGINE = InnoDB
;
...
CREATE TABLE troca_mercadoria_conc (
	codigo_loja integer not null,
	codigo_troca bigint not null,
	data_troca datetime not null,
	loja_origem integer not null,
	data_origem datetime not null,
	pdv_origem integer not null,
	cupom_origem integer not null,
	numero_cpf_cnpj varchar(16),
	rg_cliente varchar(20), 
	nome_cliente varchar(60),
	endereco varchar(60),
	telefone varchar(30),
	usuario_realizou_troca integer not null,
	situacao integer not null,
	pdv_utilizou_troca integer not null,
	cupom_utilizou_troca integer not null,
	usuario_autorizou_troca integer not null,
  	PRIMARY KEY (codigo_loja, codigo_troca, data_troca)
) ENGINE = innodb; 

CREATE TABLE IF NOT EXISTS usr_pfl_res_dsp (
 cod_usr INT NOT NULL ,
 cod_pfl INT NOT NULL ,
 dat_ult_atu TIMESTAMP NULL ,
 ina TINYINT(1) NULL ,
 PRIMARY KEY (cod_usr, cod_pfl)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS usr_res_dps (
  cod_usr BIGINT NOT NULL ,
  nom VARCHAR(255) NOT NULL ,
  lgn VARCHAR(255) NOT NULL ,
  sha VARCHAR(255) NOT NULL ,
  atv TINYINT NOT NULL DEFAULT 0 ,
  dat_ult_atu TIMESTAMP ,
  PRIMARY KEY (cod_usr))
ENGINE = InnoDB
;
...
CREATE TABLE usuario_security (
  ...
  desabilita_expiracao tinyint(1) default 0,
...
CREATE TABLE IF NOT EXISTS vda_abt (
  dat DATE NOT NULL  ,
  loj INT NOT NULL  ,
  pdv INT NOT NULL  ,
  cup INT NOT NULL  ,
...
CREATE TABLE cad_campanha_fidel(
  ...
  PRIMARY KEY (codigo_loja, codigo),  
  FOREIGN KEY(codigo_loja, codigo) REFERENCES cadastro_campanha(codigo_loja, codigo)
) ENGINE = INNODB;

CREATE TABLE cat52_ecf_intervencao_tecnica (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   cro integer not null,
   dataGravacaoCRO date not null,
   horaGravacaoCRO time not null,
   indicadorPerdaDados varchar(1) not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, cro),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao)
   ON DELETE CASCADE
) ENGINE = innodb;

CREATE TABLE cat52_ecf_numero_serie_mfd (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   numero_serie_mfd varchar(30) not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, numero_serie_mfd),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao)
   ON DELETE CASCADE
) ENGINE = innodb;

CREATE TABLE cat52_ecf_relacao_fita_detalhe (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   contador_fita_detalhe integer not null,
   data_emissao_fita_detalhe date not null,
   coo_primeiro_doc_fita_detalhe integer not null,
   coo_ultimo_doc_fita_detalhe integer not null,
   cnpj_fita_detalhe bigint not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, contador_fita_detalhe),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao)
   ON DELETE CASCADE
) ENGINE = innodb;

CREATE TABLE cat52_ecf_usuario (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   data_cadastro_usuario date not null,
   hora_cadastro_usuario time not null,
   cro integer not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, data_cadastro_usuario, hora_cadastro_usuario),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao)
   ON DELETE CASCADE
) ENGINE = innodb;

CREATE TABLE cat52_ecf_usuario_anterior (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   numero_usuario_anterior integer not null,
   data_cadastro_usuario_anterior date not null,
   hora_cadastro_usuario time not null,
   cnpj bigint not null,
   ie varchar(14) not null,
   cro integer not null,
   gt double(16,2) not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, numero_usuario_anterior),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao) 
  ON DELETE CASCADE
) ENGINE = innodb;

CREATE TABLE cat52_ecf_versao_sb (
   codigo_loja integer not null,
   numero_fabricacao varchar(30) not null,
   versaoSB varchar(10) not null,
   dataGravacaoSB date not null,
  PRIMARY KEY(codigo_loja, numero_fabricacao, versaoSB),
  FOREIGN KEY(codigo_loja, numero_fabricacao) REFERENCES cat52_ecf (codigo_loja, numero_fabricacao)
   ON DELETE CASCADE
) ENGINE = innodb;
...
CREATE TABLE config_imp_cadastro_arquivo_txt (
  id_integracao integer not null,
  id_tabela integer not null,
  nome_arquivo_parcial varchar(40) not null,
  nome_arquivo_total varchar(40) not null,
  id_conversor integer not null,
  FOREIGN KEY(id_conversor) REFERENCES conversor_arquivo_txt (id_conversor),
  PRIMARY KEY(id_integracao, id_tabela, nome_arquivo_parcial)
) ENGINE = innodb;

CREATE TABLE config_nfe_rms (
  codigo_loja integer not null,
  codigo_loja_rms integer not null default 0,
  PRIMARY KEY (codigo_loja),
  FOREIGN KEY (codigo_loja) REFERENCES loja (codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE configuracao_gateway (  
  ...
  FOREIGN KEY(id_tipo_gateway) REFERENCES tipo_gateway (id_tipo_gateway),
  constraint unique constr_gateway_prioridade(codigo_loja, prioridade),
  constraint unique constr_gateway_ip(codigo_loja, ip_gateway)
) ENGINE = innodb;
...
CREATE TABLE configuracao_gateway_tef (
  ...
  FOREIGN KEY(id_gateway) REFERENCES configuracao_gateway (id_gateway),
  constraint unique constr_ip_gateway_tef(id_gateway, ip_tef),	
  constraint unique constr_prioridade_gateway_tef(id_gateway, prioridade)	
) ENGINE = innodb;

CREATE TABLE configuracao_integracao (
  codigo_loja integer not null, 
  integracao_imp integer not null default 0,
  integracao_exp_bd integer not null default 0,
  integracao_exp_txt integer not null default 0,
  PRIMARY KEY(codigo_loja),
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE controle_cliente_conc (
  codigo_loja integer not null,
  enviar_cliente_matriz tinyint(1) not null default 0,
  ctr_cod_cli tinyint(1) not null default 0,
  PRIMARY KEY(codigo_loja),
  FOREIGN KEY(codigo_loja) REFERENCES loja(codigo_loja)    
) ENGINE = innodb;
...
CREATE TABLE conveniado (
   ...
   FOREIGN KEY(empresa_convenio) REFERENCES empresa_convenio(codigo_convenio)
) ENGINE = innodb;
...
CREATE TABLE finalizadora (
  ...
  FOREIGN KEY(tipo_finalizadora) REFERENCES tipo_finalizadora (tipo_finalizadora),
  PRIMARY KEY(codigo_finalizadora)
) ENGINE = innodb;

CREATE TABLE finalizadora_loja (
  codigo_loja integer not null,
  codigo_finalizadora integer not null,
  ...
  correspondente_batimento integer not null,
  ...
  utiliza_parcelamento_adm tinyint(1) not null default 0,
  validar_bin tinyint(1) not null default 0,
  ...
  PRIMARY KEY(codigo_loja, codigo_finalizadora),
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja),
  FOREIGN KEY(codigo_finalizadora) REFERENCES finalizadora (codigo_finalizadora)
) ENGINE = innodb;
...
CREATE TABLE hardware (
  ...
  PRIMARY KEY(codigo_hardware),
  FOREIGN KEY(tipo_hardware) REFERENCES tipo_hardware (tipo_hardware),
  constraint unique constr_hardware (tipo_hardware, fabricante, versao)
) ENGINE = innodb;
...
CREATE TABLE identificacao_campanha(
  ...
  FOREIGN KEY(codigo_loja, codigo_campanha) REFERENCES cadastro_campanha(codigo_loja, codigo)
) ENGINE = INNODB;
...
CREATE TABLE layout_nota_fiscal_loja (
  codigo_loja integer not null,
  modelo integer not null,
  categoria_campo varchar(01) not null,
  codigo_campo integer not null,
  qtde_linhas integer not null,
  qtde_colunas integer not null,
  campo_sim tinyint(1) not null default 0,
  tamanho_campo integer not null,
  posicao_linha integer not null,
  coluna_inicio_campo integer not null,
  numero_ocorrencias integer not null,
  qtde_inteiros integer not null,
  qtde_decimais integer not null,
  PRIMARY KEY(codigo_loja, modelo, categoria_campo, codigo_campo),
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja)
) ENGINE = innodb;

CREATE TABLE natureza_fiscal_estado (
  codigo_natureza varchar(3) not null,
  sigla_estado varchar(2) not null,
  PRIMARY KEY(codigo_natureza, sigla_estado),
...
CREATE TABLE numero_serie_ecf_loja (  
  ...
  PRIMARY KEY(codigo_loja, numero_serie),
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE parametros_campanha(
  ...
  FOREIGN KEY(codigo_loja) REFERENCES cadastro_campanha(codigo_loja)
) ENGINE = INNODB;
...
CREATE TABLE pdv (
  ...
  id_skin integer not null default 1,
  ...
  reg_atm_dav tinyint(1) not null default 0,
  vlr_tol_dav DOUBLE(16,3) NOT NULL DEFAULT 0,
  PRIMARY KEY(codigo_pdv),
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja),
  FOREIGN KEY(tipo_pdv) REFERENCES tipo_pdv (tipo_pdv)
) ENGINE = innodb;
...
CREATE TABLE hardware_pdv (
  ...
  paridade varchar(1),
  bits_parada integer,
  cmc7_externo tinyint(1) not null default 0,
  cmc7_imprime_cheque tinyint(1) not null default 0,
  cmc7_aceita_digitar tinyint(1) not null default 0,
  teclado_usa_visor tinyint(1) not null default 0,
  teclado_delay integer,
  teclado_timeout integer,
  pin_pad_compartilhado tinyint(1) not null default 0,
  msg_padrao_pin_pad varchar(16) not null,
  scanner_com_balanca tinyint(1) not null default 0,
  ecf_truncar tinyint(1) not null default 0,
  ecf_subtrair_posicao_finalizadora tinyint(1) not null default 0,
  modo_impr_paralela integer,
  timeout_impr_paralela integer,
  timeout_impr_serial integer,
  dir_exportacao_verificador_sweda varchar(128) not null default '',
  tipo_device integer not null default 0,
  teclado_sleep integer,
  habilitar_bip_scanner tinyint(1) not null default 0,
  PRIMARY KEY(codigo_pdv, codigo_hardware),
  FOREIGN KEY (codigo_pdv) REFERENCES pdv (codigo_pdv),
  FOREIGN KEY (codigo_hardware) REFERENCES hardware (codigo_hardware)
) ENGINE = innodb;
...
CREATE TABLE plano (
  ...
  FOREIGN KEY(codigo_tipo_parcelamento) REFERENCES tipo_parcelamento_plano (codigo),
  PRIMARY KEY(codigo_loja, codigo_plano)
) ENGINE = innodb;

CREATE TABLE pos_cam_etq_etr (  
  cod_loj INT NOT NULL , 
  cod_lay INT NOT NULL ,
  cod_cam INT NOT NULL ,
  seq INT NOT NULL ,
  des_cam VARCHAR(100) NOT NULL DEFAULT '' ,
  tam_cam INT NOT NULL ,
  ord_cam INT NOT NULL ,
  flg_cal TINYINT(1) NOT NULL DEFAULT 0 ,
  cam_cal VARCHAR(300) NOT NULL DEFAULT '' ,
  nom_cam VARCHAR(300) NOT NULL DEFAULT '' ,
  pre VARCHAR(50) NOT NULL DEFAULT '' ,
  sfx VARCHAR(50) NOT NULL DEFAULT '' ,  
  PRIMARY KEY (cod_loj, cod_lay, cod_cam, seq)
) ENGINE = InnoDB
;
...
CREATE  TABLE IF NOT EXISTS   prd_prm_brd  (
   ...
   cod_prm  INT NOT NULL  ,
   cod_prd  BIGINT NOT NULL  ,
   prd_brd  TINYINT NOT NULL DEFAULT 0  ,
  PRIMARY KEY ( cod_loj ,  cod_prm ,  cod_prd ) ,
    FOREIGN KEY ( cod_loj,  cod_prm)
    REFERENCES   prm_brd  ( cod_loj,  cod_prm)
) ENGINE = InnoDB
;
...
CREATE TABLE produto (
  ...
  PRIMARY KEY(codigo_produto),
  FOREIGN KEY(codigo_natureza) REFERENCES natureza_fiscal (codigo_natureza)
) ENGINE = innodb;
...
CREATE TABLE conjunto_produto (
  ...
  FOREIGN KEY(codigo_conj_prod) REFERENCES produto (codigo_produto),
...
CREATE TABLE produto_campanha_fidel(
  ...
  PRIMARY KEY (codigo_loja, codigo_campanha, codigo_produto),  
  FOREIGN KEY(codigo_loja, codigo_campanha) REFERENCES cadastro_campanha(codigo_loja, codigo),
  FOREIGN KEY(codigo_produto) REFERENCES ean (codigo_ean)  
) ENGINE = INNODB;
...
CREATE TABLE servico_finalizadora (
  ...
  FOREIGN KEY(codigo_servico) REFERENCES servico (codigo_servico) ON DELETE CASCADE,
  FOREIGN KEY(codigo_finalizadora) REFERENCES finalizadora (codigo_finalizadora) ON DELETE CASCADE, 
  constraint unique constr_prioridade(codigo_finalizadora, prioridade, codigo_loja)
) ENGINE = innodb;
...
CREATE TABLE servico_ip_porta (
  ...
  FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja),
  PRIMARY KEY(codigo_loja, codigo_servico)
) ENGINE = innodb;

CREATE TABLE servidor_socket (
   codigo_loja integer not null,
   ip_servidor varchar(16) not null,
   identificacao varchar(80) not null,
   monitoramento_ativo tinyint(1) not null default 0,
   mostrar_alerta_conc tinyint(1) not null default 0,
   enviar_email tinyint(1) not null default 0,
   porta_monitoramento integer not null,
   situacao_comunicacao tinyint(1) not null default 1,
   FOREIGN KEY(codigo_loja) REFERENCES loja (codigo_loja),
   PRIMARY KEY(codigo_loja, ip_servidor)
) ENGINE = innodb;

CREATE TABLE servidor_socket_email (
   codigo_loja integer not null,
   ip_servidor varchar(16) not null,
   email varchar(100) not null,
   FOREIGN KEY(codigo_loja, ip_servidor) REFERENCES servidor_socket (codigo_loja, ip_servidor),
   PRIMARY KEY(codigo_loja, ip_servidor, email)
) ENGINE = innodb;
...
CREATE TABLE totalizadores_gerenciais_ecf (
  ...
  FOREIGN KEY(codigo_hardware) REFERENCES hardware (codigo_hardware),
  FOREIGN KEY(codigo_totalizador) REFERENCES totalizadores_gerenciais (codigo_totalizador),
...
CREATE TABLE totalizadores_nao_fiscais_ecf (
  ...
  codigo_totalizador_ecf varchar(30) not null,
  FOREIGN KEY(codigo_hardware) REFERENCES hardware (codigo_hardware),
  FOREIGN KEY(codigo_totalizador) REFERENCES totalizadores_nao_fiscais (codigo_totalizador),
  PRIMARY KEY(codigo_totalizador, codigo_hardware)
) ENGINE = innodb;
...
CREATE TABLE tributacao_ecf (
  ...
  PRIMARY KEY(codigo_loja, codigo_hardware,codigo_natureza),
  FOREIGN KEY(codigo_hardware) REFERENCES hardware (codigo_hardware),
  FOREIGN KEY(codigo_natureza) REFERENCES natureza_fiscal (codigo_natureza)
) ENGINE = innodb;
...
CREATE TABLE cfg_grl_sct (
   cod_emp int not null ,
   usr varchar(30) not null ,
   sha varchar(30) not null ,
   itv_snz int not null ,
   PRIMARY KEY(cod_emp)
) ENGINE = innodb
;

CREATE TABLE cfg_loj_sct (
   cod_emp int not null ,
   cod_loj int not null ,
   ati TINYINT(1) not null ,
   cod_sct int not null ,
   dat_cad date not null ,
   PRIMARY KEY(cod_emp,cod_loj)
) ENGINE = innodb
;

CREATE TABLE cfg_url_sct (
  cod_emp int not null ,
  url varchar(50) not null ,
  ati TINYINT(1) not null ,
  PRIMARY KEY(cod_emp,url)
) ENGINE = innodb
;
...
CREATE TABLE ctr_exp_sct (
  ...
  dat DATE not null ,
  sit_err int not null ,
  prc_evd DOUBLE(16,2) not null ,
  msg_err VARCHAR(255) default '' ,
  url_env LONGTEXT NULL ,
  jso_env LONGTEXT NULL ,
  PRIMARY KEY(cod_loj,cod_pdv,num_cup,cod_prd,tip_exp,dat)
) ENGINE = innodb
;
...
;
 ...
 CREATE TABLE IF NOT EXISTS ctr_prm_sct (
  cod_loj int not null ,
  cod_itr BIGINT not null ,
  cod_ean BIGINT not null ,
  prm_sct int not null ,
  prm_itr int not null ,
  cod_prm int not null ,
  dat_ult_imp TIMESTAMP ,
  stt int not null ,
  PRIMARY KEY(cod_loj,cod_itr,cod_ean,prm_sct,prm_itr)
) ENGINE = innodb
;
...
CREATE TABLE prd_enc (
  ...
  cod_ven INT NOT NULL DEFAULT 0 ,
  qtd_rbd INT NOT NULL DEFAULT 0 ,
  qtd_rtd INT NOT NULL DEFAULT 0 ,
  loj_frn INT NOT NULL DEFAULT 0 ,
  num_oc INT NOT NULL DEFAULT 0 ,
  loj_rtd INT NOT NULL DEFAULT 0 ,
  sit INT NOT NULL DEFAULT 0 ,
  qtd_prd_can DOUBLE(16,2) NOT NULL DEFAULT 0 ,
  qtd_prd_can_aux DOUBLE(16,2) NOT NULL DEFAULT 0 ,
  PRIMARY KEY (cod_loj, num_enc, cod_prd, loj_frn, num_oc)
) ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_imp_arq (
  cod int not null ,
...
CREATE TABLE IF NOT EXISTS cfg_imp_arq_cap (
  cod int not null ,
  cod_cap int not null ,
  seq int not null ,
  PRIMARY KEY(cod, cod_cap, seq)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS ctr_agd_exp_sct (
 dat_ini_agd TIMESTAMP ,
 dat_fim_agd TIMESTAMP ,
 sit  int not null ,
 PRIMARY KEY(dat_ini_agd)
) ENGINE = innodb
;
...
CREATE TABLE cfg_cms_ope (
  nom_ope varchar(30) not null ,
  cms double not null ,
  PRIMARY KEY(nom_ope)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS mov_ccl_sat (
  ...
  num_pdv INT,
  vlr DOUBLE(16,2),
  dat_hor_ger DATETIME,
  dat_eno_sfz DATETIME,
  dat_proc_sfz DATETIME,
  rstd_proc_sefaz VARCHAR(100),
  sit_cfe INTEGER, 
  sit_bse_cmu tinyint(1) default 0,
  sit_eno INTEGER,
  proc tinyint(1) default 0,
  PRIMARY KEY (id),
  CONSTRAINT UNIQUE UQ_num_sre_hdw_num_cfe_ope (num_sre_hdw,num_cfe,ope)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS dad_adc_vch (
  cod_lot BIGINT NOT NULL,
  cod_vch BIGINT NOT NULL,
  chv INT NOT NULL,
  vlr VARCHAR(500) NULL,
  PRIMARY KEY (cod_lot, cod_vch, chv))
ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_bat_cxa (
  dat_bat DATE NOT NULL,
  cod_loj INT NOT NULL,
  num_pdv INT NOT NULL,
  num_cup INT NOT NULL,
  cod_usu INT NOT NULL,
  inc_man TINYINT NOT NULL,
  PRIMARY KEY (dat_bat,cod_loj, num_pdv, num_cup))
ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_tam_dir(
  cod_loj INTEGER NOT NULL,
  dir VARCHAR(50) NOT NULL,
  tam DOUBLE NOT NULL,
  PRIMARY KEY (cod_loj, dir)
) ENGINE = INNODB
;

CREATE TABLE ctr_tam_dir(
cod_loj int not null,
dir varchar(50) not null,
tam_lim double not null,
tam double not null,
primary key (cod_loj, dir)
)ENGINE = INNODB
;

CREATE TABLE IF NOT EXISTS dad_adc_dav (
   cod_loj  INT NOT NULL,
   cod_dav  BIGINT NOT NULL,
   num_aut  INT NOT NULL,
   num_crt  BIGINT NOT NULL,
   cod_pbm INT NOT NULL,
   ope INT NOT NULL,
   tip_cap INT NOT NULL,
   idt VARCHAR(40) NOT NULL,
   tip_idt INT NOT NULL,
   tip_psr INT NOT NULL,
   psr VARCHAR(40) NOT NULL,
   uf VARCHAR(40) NOT NULL,
   PRIMARY KEY(cod_loj, cod_dav)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cte_eno_enc (
   cod_loj  INT NOT NULL,
   num_enc  BIGINT NOT NULL,
   sit INT NOT NULL,
   PRIMARY KEY(cod_loj, num_enc)
...
CREATE TABLE ctr_prm (
  cod_loj INT NOT NULL  ,
  cod_prm INT NOT NULL  ,
  cod_prd BIGINT NOT NULL ,
  tip_prm INT NOT NULL,
  dat_cad DATE not null ,
  prc_cad DOUBLE NOT NULL,
  dat_alt DATE null ,
  cod_usu_cad INT NOT NULL ,
  nom_usu_cad VARCHAR(50) NOT NULL,
  cod_usu_alt INT NULL,
  nom_usu_alt VARCHAR(50) NULL,
  PRIMARY KEY(cod_loj,cod_prm,cod_prd,tip_prm)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS tab_pessoa_izio (
  cod_cpf bigint not null,
  nom_pessoa varchar(120) not null,
  des_nro_celular varchar(14),
  dat_aniversario datetime,
  bot_ativo integer not null,
PRIMARY KEY(cod_cpf)
) ENGINE = innodb;
...
CREATE TABLE ctr_atu_est_cup (
	dat_vda DATE NOT NULL ,
	cod_loj INT NOT NULL ,
	cod_pdv INT NOT NULL ,
	num_cup INT NOT NULL ,
	stt INT NOT NULL DEFAULT 0 ,
	PRIMARY KEY(dat_vda, cod_loj, cod_pdv, num_cup)
)ENGINE = InnoDB;

CREATE TABLE cfg_env_enc (
  cod_loj INT NOT NULL,
  qtd_env INT NOT NULL,
  tpo_env INT NOT NULL,
  hab TINYINT(1) NOT NULL,
  PRIMARY KEY(cod_loj)
) ENGINE = innodb;

CREATE TABLE ctr_env_enc_pag (
  cod_loj INT NOT NULL,
  num_oc BIGINT NOT NULL,
  cod_loj_for INT NOT NULL,
  cod_pdv INT NOT NULL,
  num_cup INT NOT NULL,
  dat_ult_env DATETIME DEFAULT NULL,
  ten_env INT NOT NULL,
  sit INT NOT NULL DEFAULT 0,
  msg_err VARCHAR(200) NOT NULL,
  PRIMARY KEY(cod_loj, num_oc, cod_loj_for, num_cup)
) ENGINE = innodb;
...
CREATE TABLE ctl_env_tsr (
  dta_mov DATE NOT NULL,
  cod_loj INT NOT NULL,
  cod_pdv INT NOT NULL,
  seq INT NOT NULL,
  sit_env INT NOT NULL,
  log_err VARCHAR(200),
  PRIMARY KEY(dta_mov, cod_loj, cod_pdv, seq)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS ctr_seq_sng (
  dat_mov DATE NOT NULL,
  cod_loj INT NOT NULL,
  cod_pdv INT NOT NULL,
  num_cup INT NOT NULL,
  cod_fin INT NOT NULL,
  seq INT NOT NULL,
PRIMARY KEY(dat_mov, cod_loj, cod_pdv, num_cup, cod_fin, seq)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS ctr_cli_nfc (
	num_loj INT NOT NULL,
	num_nfc INT NOT NULL,
	sre_nfc INT NOT NULL,
	dat_hor DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS cfg_prt_atu_bd (
  cod_loj INT NOT NULL,
  id_prt INT NOT NULL,
  vlr VARCHAR(255) NOT NULL ,
PRIMARY KEY(cod_loj, id_prt)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS ctr_prt_atu_bd (
  cod_loj INT NOT NULL,
  id_prt INT NOT NULL,
  vrs BIGINT not null,
  sit INT NOT NULL,
  dat_hor_exec datetime not null,
PRIMARY KEY(cod_loj, id_prt, vrs)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS cfg_int_wsv_ret (
  tip_int integer not null,
  hab tinyint not null,
...
CREATE TABLE IF NOT EXISTS chv_int_wsv_ret (
  tip_int integer not null,
  chv varchar(50) not null,
  vlr varchar(100) not null,
  PRIMARY KEY(tip_int, chv)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS log_exp_imp_mov (
 dat_mov DATE not null ,
 num_loj integer not null,
 num_pdv integer not null,
 num_cup integer not null,
 ...
 tip_mov integer not null,
 seq integer not null,
 sit_mov integer not null,
 ret_int varchar(200) not null,
 PRIMARY KEY(dat_mov, num_loj, num_pdv, num_cup, cod_ope, tip_mov, seq)
)ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS ctr_nfc_pen_tot (
  cod_loj INT NOT NULL,
  dat_mov date not null,
  qtd_mov long not null,
PRIMARY KEY(cod_loj, dat_mov)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS ctr_usu_atz_vrs (
  dat_atz datetime not null,
  usu INT NOT NULL,
  vrs varchar(250) not null,
PRIMARY KEY(dat_atz)
) ENGINE = innodb
;
...
CREATE TABLE ctr_grp_fid(
	cod_grp INTEGER NOT NULL DEFAULT 0,
	des VARCHAR(50),
	exg_vnc_nvl TINYINT(1) NOT NULL DEFAULT 0,
	fid TINYINT(1) NOT NULL DEFAULT 0,
	obr_vic_crt TINYINT(1) NOT NULL DEFAULT 0,
	cod_usr BIGINT NULL ,
	dat_alt timestamp null,
	nom_usr VARCHAR(50) null,
	dsb_eml TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE mov_ped (
	...
	cod INTEGER NOT NULL,
	dat_alt datetime DEFAULT NULL,
	usr BIGINT DEFAULT NULL,
	dat_abt datetime DEFAULT NULL,
	dat_fec datetime DEFAULT NULL,
	qtd INTEGER DEFAULT NULL,
	seq_ite INTEGER DEFAULT NULL,
	sit INTEGER DEFAULT NULL,
	cod_cmd INTEGER NOT NULL,
	usr_ped BIGINT DEFAULT NULL,
	num_msa INTEGER DEFAULT NULL,
...
CREATE TABLE mov_ite_ped(
	cod_loj INTEGER NOT NULL,
	cod BIGINT NOT NULL,
	dat_alt TIMESTAMP NOT NULL,
	usr BIGINT NOT NULL,
	cod_cmd_org INTEGER NOT NULL,
	cod_seq INTEGER NOT NULL,
	frc bit(1) NOT NULL,
	imd bit(1) NOT NULL,
	obs VARCHAR(255) NOT NULL,
	prc_ttl DOUBLE NOT NULL,
	prc_utl DOUBLE NOT NULL,
	qtd DOUBLE NOT NULL,
	sit INTEGER NOT NULL,
	cod_ped BIGINT NOT NULL,
	cod_prd BIGINT NOT NULL,
	usr_ped BIGINT NOT NULL,
	dat_ped TIMESTAMP NOT NULL,
	usr_can BIGINT NOT NULL,
	cpt VARCHAR(255) NULL,
	dsc_prd VARCHAR(255) NOT NULL,
	dsc_sit VARCHAR(255) NOT NULL,
	cod_grp INTEGER NOT NULL,
	ipm TINYINT(1) NOT NULL,
	dat_ent TIMESTAMP,
	usu_ent INTEGER NOT NULL,
	PRIMARY KEY(cod_loj, cod)
)ENGINE = innodb
;

CREATE TABLE mov_prf_ped(
	cod_loj INTEGER NOT NULL,
	cod BIGINT NOT NULL,
	dat_ped TIMESTAMP NOT NULL,
	prc DOUBLE NOT NULL,
    adc_sub bit(1) DEFAULT NULL,
	cod_prf INTEGER NOT NULL,
	cod_ite_ped BIGINT NOT NULL,
	des VARCHAR(255) NOT NULL,
	qtd DOUBLE NOT NULL,
	PRIMARY KEY(cod_loj, cod)
)ENGINE = innodb
...
CREATE TABLE IF NOT EXISTS ctr_blc_ckt (
  ...
  ctr_blc_est_pso_ngt TINYINT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cad_pre_gs1 (
  ...
  ind_esp INT NOT NULL,
  pais_nom VARCHAR(255) NOT NULL,
  PRIMARY KEY (pre_ini, pre_fim))
ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_eml_sis (
  	cod_loj INT NOT NULL ,
  	tip_eml INT NOT NULL ,
  	eml_rem VARCHAR(255) NOT NULL ,
  	end_stp VARCHAR(255) NOT NULL ,
  	pta_stp VARCHAR(255) NOT NULL  ,
  	usu_eml VARCHAR(255) NOT NULL ,
  	...
  	ass VARCHAR(255) NOT NULL ,
  	tip_ptc_seg INT NOT NULL ,
  	PRIMARY KEY (cod_loj, tip_eml)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cad_env_eml_sis (
	cod_loj INT NOT NULL,
	tip_eml INT NOT NULL,
	eml VARCHAR(255) NOT NULL,
	PRIMARY KEY (cod_loj, tip_eml, eml)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cad_txt_eml_sis (
	tip_eml INT NOT NULL,
	seq INT NOT NULL,
	txt VARCHAR(255) NOT NULL,
	PRIMARY KEY(tip_eml, seq)
) ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_tpt_eml (
	tip_eml INT NOT NULL,
	seq INT NOT NULL,
	txt VARCHAR(255) NOT NULL,
	PRIMARY KEY(tip_eml, seq)
...
CREATE TABLE ctr_exp_mov (
   	dat_mov DATE NOT NULL,
   	num_loj INT NOT NULL DEFAULT 0,
   	num_pdv INT NOT NULL DEFAULT 0,
   	num_cup INT NOT NULL DEFAULT 0,
   	cod_ope INT NOT NULL DEFAULT 0,
   	tip_mov INT NOT NULL DEFAULT 0,
   	seq INT NOT NULL DEFAULT 0,
   	dat_hor_ult_proc DATETIME,
   	qtd_proc INT NOT NULL DEFAULT 0,
   	PRIMARY KEY(dat_mov, num_loj, num_pdv, num_cup, cod_ope, tip_mov, seq)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS ctr_crg_pdi (
 	cod_loj int not null ,
 	opc_crg int not null ,
	tip_crg int not null,
 	seq int not null ,
	tot int not null,	
 	jso longtext,
 	pen tinyint(1) not null default 0 ,
 	num_crg int not null ,
 	cod_int int not null,
	PRIMARY KEY(cod_loj,opc_crg,tip_crg,seq, cod_int)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS cfg_crg_pdi (
  cod_loj int not null ,
  opc_crg int not null ,
  hab tinyint(1) not null default 0 ,
  cod_int int not null ,
  PRIMARY KEY(cod_loj,opc_crg,cod_int)
) ENGINE = innodb
;

CREATE TABLE cfg_crg_pdi_tip (
  cod_loj int not null ,
  opc_crg int not null ,
  tip int not null ,
  dsb tinyint(1) not null default 0 ,
  cod_int int not null ,
  PRIMARY KEY(cod_loj,opc_crg, tip,cod_int)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS agd_crg_pdi (
	cod_loj int not null ,
	opc_crg int not null ,
	tip_crg int not null ,
	num_crg int not null ,
	dat_crg timestamp not null,
	crg_pen tinyint(1) not null default 0 ,
	suc_exp tinyint(1) not null default 0 ,
	dat_hor_exp timestamp not null,
	prc tinyint(1) not null default 0 ,
	dat_hor_prc timestamp not null,
	cod_int int not null ,
	PRIMARY KEY(cod_loj,opc_crg, tip_crg, cod_int)
) ENGINE = innodb
;
...
CREATE TABLE mov_fin_srv (
	cod_loj INTEGER NOT NULL,
	cod_mov_fin INTEGER NOT NULL,
	cod_fin INTEGER NOT NULL,
	cod_srv INTEGER NOT NULL,
	PRIMARY KEY(cod_loj, cod_mov_fin, cod_fin)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS ctr_dvl_vlr_vda (
	dat_vda DATE NOT NULL,
    num_loj INT NOT NULL,
    num_pdv INT NOT NULL,
    num_cup INT NOT NULL,
    ...
    prc double NOT NULL,
    tot double NOT NULL,
    ajt_pst double NOT NULL,
    ajt_ngt double NOT NULL,
    dsc VARCHAR(50) NOT NULL,
    dat_dvl DATE NOT NULL,
    prc_gdl double not null,
...
CREATE TABLE IF NOT EXISTS cfg_ems_etq(
	cod_loj INT NOT NULL,
	vtl_qtd_pdr TINYINT(1) NOT NULL DEFAULT 0,
	vlr_qtd_pdr INT NOT NULL DEFAULT 1,
	PRIMARY KEY(cod_loj)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS crg_cli_fid(
	cpf_cnpj BIGINT NOT NULL DEFAULT 0,
	nome VARCHAR(100),
	codigo_cliente BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS  crg_grp_cli_fid (
	cod_grp INTEGER NOT NULL,
	cpf_cnj BIGINT NOT NULL,
	niv_atu INTEGER NOT NULL,
	dsb tinyint(1) not null default 0 ,
	PRIMARY KEY(cod_grp, cpf_cnj)
) ENGINE = innodb;
;

CREATE TABLE IF NOT EXISTS ctr_exe_int_dad(
   tip_int INTEGER NOT NULL,
   exe TINYINT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS nao_eme_via_etb_ctg(
	cod_loj INT NOT NULL,
	dat_hor TIMESTAMP NOT NULL,
	usu VARCHAR(50) NOT NULL,
	nao_eme_via_etb_ctg TINYINT(1) NOT NULL,
	PRIMARY KEY(cod_loj, dat_hor)
) ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_rjc_nfc(
	cod_loj INT NOT NULL,
	tip_srv INT NOT NULL,
	dat_hor_ult_env DATETIME NULL,
	qtd_env INT NOT NULL DEFAULT 0,
	PRIMARY KEY(cod_loj, tip_srv)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_int_myt(
	 cod_loj INT NOT NULL,
	 url VARCHAR(50) NOT NULL,
	 tok VARCHAR(255)NOT NULL,
	 PRIMARY KEY (cod_loj)
...
CREATE TABLE IF NOT EXISTS mov_xml_doc_etr (
  dat_vda DATE NOT NULL,
  num_loj INT NOT NULL,
  num_pdv INT NOT NULL,
  num_cup INT NOT NULL,
  tip_doc INT NOT NULL,
  tip_ope INT NOT NULL,
  chv_acs VARCHAR(60) NOT NULL,
  num_cfe INT NOT NULL,
  num_sre BIGINT NOT NULL,
  dat_hor_ems TIMESTAMP NULL,
  dat_hor_rcb TIMESTAMP NULL,
  num_rcb BIGINT NULL,
  cod_sfz INT NOT NULL,
  xml_dist LONGTEXT NOT NULL,
  vrs_lay_nfc DOUBLE NULL,
  PRIMARY KEY (dat_vda, num_loj, num_pdv, num_cup, tip_doc, tip_ope)
)ENGINE = InnoDB;
...
CREATE TABLE  e00_identificacao_software_house_dmcard (
   data_venda date not null,
   numero_loja integer not null,
   tipo varchar(3) not null,
   cnpj_cpf_software_house bigint not null,
   ie_software_house varchar(14) not null,
   nome_software_house varchar(40) not null,
   nome_aplicativo varchar(40) not null,
   versao_aplicativo varchar (10) not null,
  PRIMARY KEY(data_venda, numero_loja, tipo)
) ENGINE = innodb;

CREATE TABLE  e02_identificacao_contribuinte_dmcard (
   data_venda date not null,
   numero_loja integer not null,
   tipo varchar(3) not null,
   cnpj_estabelecimento_usuario bigint not null,
...
CREATE TABLE e14_cupom_fiscal_dmcard (
   data_venda date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   tipo varchar(3) not null,
   ...
   nome_adquirente varchar(40) not null,
   cpf_cnpj_adquirente bigint not null,
   cpf_cnpj_fidelidade bigint,
   valor_total_pontuar double(16,2),
   codigo_operador_caixa long,
   nome_operador_caixa varchar(40),
   hora_emissao_cupom varchar(6),
   chave_acesso_sat varchar(50),
  PRIMARY KEY(data_venda, numero_loja, numero_pdv, tipo, numero_fabricacao, coo)
) ENGINE = innodb;

CREATE TABLE e15_detalhe_cupom_fiscal_dmcard (
   data_venda date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   tipo varchar(3) not null,
...
CREATE TABLE e21_detalhe_cupom_fiscal_meio_pagamento_dmcard (
   data_venda date not null,
   numero_loja integer not null,
   numero_pdv integer not null,
   tipo varchar(3) not null,
   ...
   valor_estornado double(16,2) not null,
   gnf integer,
   autorizacao_credito long,
  PRIMARY KEY(data_venda, numero_loja, numero_pdv, tipo, numero_fabricacao, coo, seq)
) ENGINE = innodb;

CREATE TABLE ead_totalizador_arquivo_dmcard (
   numero_loja integer not null,
   tipo varchar(3) not null,
   quantidade_cupons integer,
   quantidade_linhas long,
   data_venda date not null,
   versao_arquivo varchar(4),
  PRIMARY KEY(data_venda, numero_loja, tipo)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS cad_lst_cmp_fid (
	id BIGINT NOT NULL,
	nom VARCHAR(255) NOT NULL,
	cpf_cnj BIGINT NOT NULL,
	dat_hor DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS cad_lst_cmp_ite_fid (
	id_lst BIGINT NOT NULL,
	seq INT NOT NULL,
	nom VARCHAR(255) NOT NULL,
	qtd DOUBLE NOT NULL,
	cmp TINYINT(1) NOT NULL DEFAULT 0,
	PRIMARY KEY(id_lst, seq)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS mov_cnf_cup (
	dat_cup DATE NOT NULL,
	num_loj INT NOT NULL,
	num_pdv INT NOT NULL,
	num_cup INT NOT NULL,
	seq INT NOT NULL,
	cod_ope INT NOT NULL,
	nom_ope VARCHAR(500) NULL,
	cpf_cnj VARCHAR(20) NULL,
	dat_hor_cnf DATETIME NULL, 
	usu_cnf VARCHAR(50) NULL, 
	nom_usu_cnf VARCHAR(500) NULL,
	usu_fim_cnf INT,
	nom_usu_fim_cnf VARCHAR(500),
	dat_hor_fim_cnf DATETIME, 
	stt INT NOT NULL,
	vlr_cup DOUBLE not null,
	qrcode TEXT NULL ,
	vlr_lqd DOUBLE not null,
	PRIMARY KEY(dat_cup, num_loj, num_pdv, num_cup, seq)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS mov_cnf_det_cup (
	dat_cup DATE NOT NULL,
	num_loj INT NOT NULL,
	num_pdv INT NOT NULL,
	num_cup INT NOT NULL,
	...
	stt INT NOT NULL,
	qtd_ltr INT NOT NULL,
	PRIMARY KEY(dat_cup, num_loj, num_pdv, num_cup, cod_ean)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_cnf_cup (
	num_loj INT NOT NULL,
	qtd_min_cnf INT NOT NULL,
	pmt_cnf_dia_ant TINYINT(1) NOT NULL,
	obr_cnf_acm DOUBLE NOT NULL,
	itv_cnf  INT NOT NULL,
	PRIMARY KEY( num_loj)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_ite_cnf_cup (
	num_loj INT NOT NULL,
	vlr_ite_cnf DOUBLE NOT NULL,
	tip_cnf_vlr INT NOT NULL,
	qtd_ite_cnf DOUBLE NOT NULL,
	tip_cnf_qtd INT NOT NULL,
	PRIMARY KEY( num_loj)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_prd_cnf_cup (
	num_loj INT NOT NULL,
	sec INT NOT NULL,
	grp INT NOT NULL,
	sub_grp INT NOT NULL,
	prd BIGINT NOT NULL,
	tip_cnf INT NOT NULL,
	PRIMARY KEY( num_loj, sec, grp, sub_grp, prd)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS ctr_seq (
	tip_seq BIGINT(20) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS mov_vda_prd_cto_cpf_cnj (
	dat_mov DATE,
	loj INT NOT NULL,
	pdv INT NOT NULL,
	cup INT NOT NULL,
	...
	prd BIGINT NOT NULL,
	cte_vda INT NOT NULL,
	qtd_cmp DOUBLE NOT NULL,
	stt_prd INT NOT NULL,
	PRIMARY KEY(dat_mov, loj, pdv, cup, seq)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS mov_cli_prd_cto_cpf_cnj(
	loj INT NOT NULL,
	pdv INT NOT NULL,
	cup INT NOT NULL,
	dat DATE,
...
CREATE TABLE IF NOT EXISTS cpf_rtc (
	cpf BIGINT NOT NULL ,
	tip INTEGER NOT NULL ,
  PRIMARY KEY (cpf))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS dad_fin_erp (
	cod_erp VARCHAR(5) NOT NULL,
	tip_vda VARCHAR(5) NOT NULL,
	tip_fin  INT NOT NULL,
	PRIMARY KEY (cod_erp)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS dad_fin_erp_ecn (
	cod_erp VARCHAR(5) NOT NULL,
	cod_ecn INT NOT NULL,
	PRIMARY KEY (cod_erp, cod_ecn)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS usu_erp(
	id_erp INT NOT NULL,
	lgn_usu INT NOT NULL,
	PRIMARY KEY(id_erp, lgn_usu)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cte_env_psh (
	itr INTEGER NOT NULL,
	seq BIGINT NOT NULL,
	chv VARCHAR(500) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cfg_env_psh (
	itr INTEGER NOT NULL,
	tip INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS cfg_dsp_psh (
	itr INTEGER NOT NULL,
	tip INTEGER NOT NULL,
	cpf_cnj BIGINT NOT NULL,
	id_dsp VARCHAR(500) NOT NULL,
  PRIMARY KEY (itr, tip, cpf_cnj)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS map_res_det_cpl (
   dat_mov date not null,
   cod_loj integer not null, 
   cod_pdv integer not null,
   seq integer not null,
   seq_cpl integer not null,
   cod_tot varchar(10),
   val_aqt double(16,2) not null,
   bas_imp double(16,2) not null,
   tot_imp double(16,2) not null,
   PRIMARY KEY(dat_mov, cod_loj, cod_pdv, seq, seq_cpl)
) ENGINE = innodb;

CREATE TABLE IF NOT EXISTS lot_num_trn_vda (
  idt_int BIGINT NOT NULL,
  pxm_num BIGINT NOT NULL,
  ult_num BIGINT NOT NULL,
  PRIMARY KEY (idt_int)
)ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS ctr_cad_xml_nfc (
  cod_loj INT NOT NULL ,
  ncm INT NOT NULL ,
  cst VARCHAR(3) not null,
  cod_bnf_fsc varchar(10) not null,
  alq DOUBLE NOT NULL,
  per_red_bc DOUBLE NOT NULL,
  fcp DOUBLE NOT NULL,
  dat_atz DATE NOT NULL,
  PRIMARY KEY (cod_loj, ncm, cst)
)ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS mov_cup_nfc (
  dta_vda DATE NOT NULL,
  num_loj INT NOT NULL ,
  num_pdv INT NOT NULL ,
  num_cup INT NOT NULL ,
  ope INT NOT NULL ,
  ...
  qrcode TEXT NULL ,
  vrs_lay_nfc DOUBLE NULL ,
  PRIMARY KEY (dta_vda, num_loj, num_pdv, num_cup, ope)
  )ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS ctr_env_nfc (
  dta_vda DATE NOT NULL,
  num_loj INT NOT NULL ,
  num_pdv INT NOT NULL ,
  num_cup INT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS ctr_env_xml_cup_nfc (
  dta_vda DATE NOT NULL,
  num_loj INT NOT NULL ,
  num_pdv INT NOT NULL ,
  num_cup INT NOT NULL ,
...
CREATE TABLE stt_srv_sfz (
	cod_loj INT NOT NULL,
	uf VARCHAR(2) NOT NULL,
	cod_stt INT NOT NULL,
	mtv VARCHAR(150) NOT NULL,
	tpo_mdi VARCHAR(10) NOT NULL,
	obs VARCHAR(150) NOT NULL,
	dat_hor_cns TIMESTAMP NOT NULL,
	PRIMARY KEY (cod_loj)
)ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS prd_cph_pmo_dat (
  cod_loj INT NOT NULL  ,
  dat DATE NOT NULL,
  seq_pmo BIGINT NOT NULL  ,
  pmo VARCHAR(40) NOT NULL  ,
  pmo_rtd TINYINT(1) NOT NULL DEFAULT 0  ,
  num_pmo BIGINT,
  PRIMARY KEY (cod_loj, dat, seq_pmo)
 )ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS seq_cph_pmo_dat (
  cod_loj INT NOT NULL  ,
  dat DATE NOT NULL ,
  seq_vda BIGINT NULL  ,
  PRIMARY KEY (cod_loj, dat)
 )ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cfg_pgt_dps (
 cod_loj INT NOT NULL,
 ip VARCHAR(20) NOT NULL,
 emp VARCHAR(10) NOT NULL,
 trm VARCHAR(10) NOT NULL,
 fin_deb INT NOT NULL,
 fin_cre INT NOT NULL,
 dat_atu TIMESTAMP NULL,
 url_api_nfc VARCHAR(50) NOT NULL,
 PRIMARY KEY (cod_loj)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS pgt_ped (
 cod_loj INT NOT NULL,
 id BIGINT NOT NULL,
 seq INT NOT NULL,
 ped BIGINT NOT NULL,
 ...
 vlr DOUBLE NOT NULL,
 tco DOUBLE NOT NULL,
 cod_mdd VARCHAR(20) NOT NULL,
 cod_red_aut INT NOT NULL,
 cod_ban INT NOT NULL,
 nsu VARCHAR(20) NOT NULL,
 cod_aut VARCHAR(20) NOT NULL,
 bin INT NOT NULL,
 qtd_par INT NOT NULL,
 tip_crt VARCHAR(20) NOT NULL,
 trn INT NOT NULL,
 cpf VARCHAR(15) NULL,
PRIMARY KEY (cod_loj, id, seq)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_sre_nfc_dsp (
   cod_loj integer not null, 
   sre_dsp varchar(50) not null,
   sre_nfc integer not null,
   PRIMARY KEY(cod_loj, sre_dsp, sre_nfc)
) ENGINE = innodb;

CREATE TABLE IF NOT EXISTS ctr_pgt_pen_res (
	num_loj integer not null,
	num_pdv integer not null,
	ped BIGINT NOT NULL, 
	...
	cod_sfz integer not null,
	qrcode TEXT NULL ,
	tip_ems integer not null,
	usu_fch integer not null,
	PRIMARY KEY(num_loj, num_pdv, ped)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS ret_pgt_ped (
	num_loj integer not null,
	num_pdv integer not null,
	ped BIGINT NOT NULL, 
	seq integer not null,
	msg VARCHAR(100),
	PRIMARY KEY(num_loj, num_pdv, ped, seq)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS cte_crg_pro (
	id INTEGER NOT NULL AUTO_INCREMENT,
    tip_crg INTEGER NOT NULL,
	dat_crg DATE NOT NULL,
	PRIMARY KEY(id)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS cte_eno_aws (
	id INTEGER NOT NULL AUTO_INCREMENT,
    nom_arq VARCHAR(255) NOT NULL,
	evd TINYINT(1) NOT NULL,
	PRIMARY KEY(id)
) ENGINE = innodb
;

CREATE TABLE IF NOT EXISTS mov_tco_spl (
   data_movimento date not null,
   codigo_operador int not null,
   numero_loja integer not null,
   numero_pdv int not null,
...
CREATE TABLE ctr_int_eca_tco_spl (
	dat_ino_eno DATE NOT NULL ,
	dat_fim_eno DATE NOT NULL,
	seq INT NOT NULL,
	tip INT NOT NULL,
	qtd_cup_evd INT,
	cod_ret INT,
	jso_eno LONGTEXT,
	jso_ret LONGTEXT,
	PRIMARY KEY(dat_ino_eno, dat_fim_eno, seq, tip)
) ENGINE = innodb;
...
CREATE TABLE IF NOT EXISTS ctr_cad_fam_prd (
  cod_loj INT NOT NULL  ,
  cod_fam INT NOT NULL ,
  cod_prd BIGINT NOT NULL ,
  cod_pai TINYINT(1) NOT NULL,
  PRIMARY KEY (cod_loj, cod_fam, cod_prd)
 )
 ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cad_int (
	cod_int integer NOT NULL ,
    des varchar(50) NOT NULL ,
    hab TINYINT(1) NOT NULL ,
    hab_fch TINYINT(1) NOT NULL ,
    stt TINYINT(1) NOT NULL,
    inf_adc LONGTEXT NULL,
    PRIMARY KEY(cod_int)
) ENGINE = innodb;

CREATE TABLE IF NOT EXISTS cte_eno_ctd (
  	num_loj INTEGER NOT NULL ,
  	tip_ctd INTEGER NOT NULL ,
  	dat_ult_eno DATETIME ,
  	dat_epr_ctd DATETIME NOT NULL ,    
  	cmh_ctd VARCHAR(500) NOT NULL ,
  	snh_ctd VARCHAR(250) NOT NULL   ,
  	ctd_dig BLOB NOT NULL ,
  	tip_ctd_dig INTEGER NOT NULL DEFAULT 1   ,
  	raz_soc VARCHAR(100) NOT NULL ,
  	ale_epr INTEGER DEFAULT 0 ,
  	sit_eno INTEGER NOT NULL DEFAULT 0 ,
  	dat_rec_loj DATETIME ,
  	PRIMARY KEY(num_loj, tip_ctd)
) ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS his_trf_msa (
 ped BIGINT NOT NULL,
 num_loj INT NOT NULL,
 msa_ori INT NOT NULL,
 msa_dtn INT NOT NULL,
 dat_alt DATETIME,
 usu INT NOT NULL,
PRIMARY KEY (ped, num_loj, msa_ori, msa_dtn)
)ENGINE = InnoDB
;
...
CREATE TABLE IF NOT EXISTS cte_crg_dia_pro (
	id INTEGER NOT NULL AUTO_INCREMENT,
	dat_crg DATE NOT NULL,
	PRIMARY KEY(id)
) ENGINE = innodb
...
CREATE TABLE IF NOT EXISTS ctr_stt_srv (
 num_loj INT NOT NULL,
 tip_srv INT NOT NULL,
 url VARCHAR(40) NOT NULL,
 stt TINYINT(1) NOT NULL DEFAULT 0,
 dat_cns DATETIME NULL,
 vrs VARCHAR(40) NULL,
 dat_atz DATETIME NULL,
 bld_apc VARCHAR(40) NULL,
 PRIMARY KEY(num_loj, tip_srv, url)
)ENGINE = InnoDB
;

CREATE TABLE cad_tip_srv (
 tip_srv INT NOT NULL,
 des_srv VARCHAR(40) NOT NULL,
 srv_ccd TINYINT(1) NOT NULL DEFAULT 0,
 mod_mtz TINYINT(1) NOT NULL DEFAULT 0,
 inf_adc LONGTEXT NULL,
 PRIMARY KEY(tip_srv)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS ctr_stt_tms_dad(
 num_loj INT NOT NULL,
 num_pdv INT NOT NULL,
 tip_tms_dad INT NOT NULL,
 stt TINYINT(1) NOT NULL DEFAULT 0,
 dat_cns DATETIME NOT NULL,
 PRIMARY KEY(num_loj, num_pdv, tip_tms_dad)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_tfa_grl(
 cod_tfa INT NOT NULL,
 itv_mnt INT NOT NULL,
 PRIMARY KEY(cod_tfa)
)ENGINE = InnoDB
;

CREATE TABLE IF NOT EXISTS cfg_imp_crg (
	num_loj INTEGER NOT NULL,
	tip_imp INTEGER NOT NULL,
	imp TINYINT(1) NOT NULL DEFAULT 0,
	PRIMARY KEY(num_loj, tip_imp)
) ENGINE = innodb
;
...
CREATE TABLE IF NOT EXISTS ctr_reg_pre_vda (
	dat DATE NOT NULL,
	num_loj INT NOT NULL,
	num_pdv INT NOT NULL,
	num_cup INT NOT NULL,
	...
	vlr_ite DOUBLE(16, 2),
	vlr_div DOUBLE(16, 2),
	PRIMARY KEY(dat, num_loj, num_pdv, num_cup)
) ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS ctr_reg_pre_vda_prd (
	dat DATE NOT NULL,
	num_loj INT NOT NULL,
	num_pdv INT NOT NULL,
	num_cup INT NOT NULL,
	...
	cod_prd BIGINT NOT NULL,
	cod_ean BIGINT,
	msg_err VARCHAR(255) NULL,
	PRIMARY KEY(dat, num_loj, num_pdv, num_cup, cod_pre_vda, seq)
) ENGINE = InnoDB;

CREATE INDEX index_secao_grupo_subgrupo_desc ON secao_grupo_subgrupo (descricao(40));
CREATE INDEX index_produto_descricao ON produto (descricao(60));
CREATE INDEX index_produto_descr_reduz ON produto (descricao_reduzida(20));
CREATE INDEX index_secao_grupo_sub ON produto (codigo_secao, codigo_grupo, codigo_sub_grupo);
CREATE INDEX index_produto_atu ON produto (data_atualizacao);
CREATE INDEX index_produto_loja_atu ON produto_loja (data_atualizacao);
CREATE INDEX index_prod_nat_est_atu ON produto_natureza_estado (data_atualizacao);
CREATE INDEX index_produto_livraria_atu ON produto_livraria (data_atualizacao);
CREATE INDEX index_ean_codigo_produto ON ean (codigo_produto);
CREATE INDEX index_ean_atu ON ean (data_atualizacao);
CREATE INDEX index_nivel_preco_produto_preco ON nivel_preco_produto (data_preco);
CREATE INDEX index_nivel_preco_produto_atu ON nivel_preco_produto (data_atualizacao);
CREATE INDEX index_promocao_mix_desc ON promocao_mix (descricao(20));
CREATE INDEX index_cliente_cpf ON cliente (cpf);
CREATE INDEX index_cliente_atu ON cliente (data_atualizacao);
CREATE INDEX index_empr_conv_atu ON empresa_convenio (data_atualizacao);
CREATE INDEX index_conveniado_atu ON conveniado (data_atualizacao);
CREATE INDEX index_capa_cupom_venda_cpf ON capa_cupom_venda (numero_cpf_cnpj(16));
CREATE INDEX index_detalhe_cupom_venda_descricao ON detalhe_cupom_venda (descricao(20));
CREATE INDEX index_data_loja_fabric ON mapa_resumo (data_movimento, numero_loja, numero_serie_ecf);
CREATE INDEX index_perfil_nome ON perfil (nome(45));
CREATE INDEX index_usuario_security_nome ON usuario_security (nome(100));
CREATE INDEX index_produto_controlado_desc ON produto_controlado (descricao(60));
CREATE INDEX index_prod_contr_atu ON produto_controlado (data_atualizacao);
CREATE INDEX index_prod_contr_loja_atu ON produto_controlado_loja (data_atualizacao);
CREATE INDEX index_moeda_estrangeira_desc ON moeda_estrangeira (descricao(20));
CREATE INDEX index_data_loja_fabric ON e10_relacao_fitas_detalhe_emitidas (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e11_posicao_atual_contadores_totalizadores (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e12_relacao_reducoes_z (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e13_detalhe_reducao_z (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e14_cupom_fiscal (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e15_detalhe_cupom_fiscal (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e16_demais_documentos_emitidos (data_venda, numero_loja, numero_fabricacao);
CREATE INDEX index_data_loja_fabric ON e21_detalhe_cupom_fiscal_meio_pagamento (data_venda, numero_loja, numero_fabricacao);
...
CREATE INDEX index_mov_sat_dat_mov ON mov_sat (dat_mov);
CREATE INDEX index_mov_sat_num_loj ON mov_sat (num_loj);
CREATE INDEX index_mov_sat_num_pdv ON mov_sat (num_pdv);
CREATE INDEX index_mov_sat_num_cfe ON mov_sat (num_cfe);
CREATE INDEX index_mov_sat_num_sre_hdw ON mov_sat (num_sre_hdw);
CREATE INDEX index_mov_sat_seq ON mov_sat (seq);
CREATE INDEX index_mov_sat_ope ON mov_sat (ope);
CREATE INDEX index_mov_sat_num_cup ON mov_sat (num_cup);
CREATE INDEX index_mov_sat_chv_acs ON mov_sat (chv_acs);
CREATE INDEX index_mov_sat_num_ses ON mov_sat (num_ses);
CREATE INDEX index_mov_nfc_dat_hor_ems ON mov_nfc (dat_hor_ems);
CREATE INDEX index_mov_nfc_num_loj ON mov_nfc (num_loj);
CREATE INDEX index_mov_nfc_num_nfc ON mov_nfc (num_nfc);
CREATE INDEX index_mov_nfc_sre_nfc ON mov_nfc (sre_nfc);
CREATE INDEX index_mov_nfc_ope ON mov_nfc (ope);
CREATE INDEX index_mov_nfc_num_pdv ON mov_nfc (num_pdv);
CREATE INDEX index_mov_tip_ems ON mov_nfc (tip_ems);
CREATE INDEX index_mov_cod_sfz ON mov_nfc (cod_sfz);
CREATE INDEX index_mov_sit_env_nfc ON mov_nfc (sit_env_nfc);
CREATE INDEX index_mov_nfc_num_lot ON mov_nfc (num_lot);
...
CREATE INDEX index_ctr_exp_sct_prd_tip ON ctr_exp_sct (cod_prd, tip_exp);
CREATE INDEX idx_prd_prm_gbl on prd_prm_gbl (cod_prm,fbt,mrc,prd,crt_fml,sec,grp,sgr,dtm);
CREATE INDEX idx_ctr_int_vda on ctr_int_vda (tip_int, stt_int);
CREATE INDEX idx_ctr_int_vda_data on ctr_int_vda (dat_mov, tip_int, stt_int);
CREATE INDEX idx_ctr_int_fch on ctr_int_fch (tip_fch, tip_int, stt_int);
CREATE INDEX idx_ctr_int_fch_data on ctr_int_fch (dat_mov, tip_fch, tip_int, stt_int);
CREATE INDEX idx_mov_vch_dat_loj_tip ON mov_vch (dat_mov, cod_loj, tip_mov);
CREATE INDEX idx_mov_vch_cod_vch ON mov_vch (cod_vch);
CREATE INDEX idx_mov_vch_cta ON mov_vch (dat_ini_vig, dat_fim_vig, cpf, cod_prm);
CREATE INDEX idx_exp_imp_mov_sit_proc on exp_imp_movimento (situacao_movimento, dat_hor_proc);
CREATE INDEX idx_mov_xml_doc_etr ON mov_xml_doc_etr (num_loj, num_cfe, num_sre);
CREATE INDEX idx_mov_xml_doc_etr_cup ON mov_xml_doc_etr (dat_vda, num_loj, num_pdv, num_cup);
CREATE INDEX idx_dav_dat ON dav (data);
CREATE INDEX idx_dav_cod_ven ON dav (cod_ven);
CREATE INDEX idx_cod_pre_venda ON detalhe_cupom_venda (codigo_pre_venda);

CREATE INDEX idx_mov_xml_doc_etr_cupom ON mov_xml_doc_etr (dat_vda, num_loj, num_pdv, num_cup);
CREATE INDEX idx_mov_xml_doc_etr_chv_acs ON mov_xml_doc_etr (chv_acs);
CREATE INDEX idx_mov_xml_doc_etr_dat ON mov_xml_doc_etr (dat_vda);
CREATE INDEX idx_mov_xml_doc_etr_lojt ON mov_xml_doc_etr (num_loj);
CREATE INDEX idx_mov_xml_doc_etr_pdv ON mov_xml_doc_etr (num_pdv);
CREATE INDEX idx_mov_xml_doc_etr_num_cup ON mov_xml_doc_etr (num_cup);
CREATE INDEX idx_mov_xml_doc_etr_cfe ON mov_xml_doc_etr (num_cfe);
CREATE INDEX idx_mov_xml_doc_etr_sre ON mov_xml_doc_etr (num_sre);
CREATE INDEX idx_mov_xml_doc_etr_doc ON mov_xml_doc_etr (tip_doc);
CREATE INDEX idx_mov_xml_doc_etr_ope ON mov_xml_doc_etr (tip_ope);
CREATE INDEX idx_mov_xml_doc_etr_chaves ON mov_xml_doc_etr (chv_acs, tip_doc, tip_ope);

CREATE INDEX idx_mov_cup_nfc_cupom ON mov_cup_nfc (dta_vda, num_loj, num_pdv, num_cup);
CREATE INDEX idx_mov_cup_nfc_chaves ON mov_cup_nfc (dta_vda, num_loj, num_pdv, num_cup, ope);
CREATE INDEX idx_mov_cup_nfc_chv_acs ON mov_cup_nfc (chv_acs);
CREATE INDEX idx_mov_cup_nfc_dta_vda ON mov_cup_nfc (dta_vda);
CREATE INDEX idx_mov_cup_nfc_num_loj ON mov_cup_nfc (num_loj);
CREATE INDEX idx_mov_cup_nfc_num_pdv ON mov_cup_nfc (num_pdv);
CREATE INDEX idx_mov_cup_nfc_num_cup ON mov_cup_nfc (num_cup);
CREATE INDEX idx_mov_cup_nfc_ope ON mov_cup_nfc (ope);
CREATE INDEX idx_mov_cup_nfc_sre_nfc ON mov_cup_nfc (num_lot, sre_nfc);
CREATE INDEX idx_mov_cup_nfc_sefaz ON mov_cup_nfc (num_loj, num_lot, sre_nfc);

CREATE INDEX idx_ctr_env_nfc_cupom ON ctr_env_nfc (dta_vda, num_loj, num_pdv, num_cup);
CREATE INDEX idx_ctr_env_nfc_chaves ON ctr_env_nfc (dta_vda, num_loj, num_pdv, num_cup, ope);
CREATE INDEX idx_ctr_env_nfc_chv_acs ON ctr_env_nfc (chv_acs);
CREATE INDEX idx_ctr_env_nfc_dta_vda ON ctr_env_nfc (dta_vda);
CREATE INDEX idx_ctr_env_nfc_num_loj ON ctr_env_nfc (num_loj);
CREATE INDEX idx_ctr_env_nfc_num_pdv ON ctr_env_nfc (num_pdv);
CREATE INDEX idx_ctr_env_nfc_num_cup ON ctr_env_nfc (num_cup);
CREATE INDEX idx_ctr_env_nfc_ope ON ctr_env_nfc (ope);
CREATE INDEX idx_ctr_env_nfc_lot ON ctr_env_nfc (num_lot, sre_nfc);
CREATE INDEX idx_ctr_env_nfc_sefaz ON ctr_env_nfc (num_loj, num_lot, sre_nfc);

CREATE INDEX idx_ctr_env_xml_cup_nfc_cupom ON ctr_env_xml_cup_nfc (dta_vda, num_loj, num_pdv, num_cup);
CREATE INDEX idx_ctr_env_xml_cup_nfc_chaves ON ctr_env_xml_cup_nfc (dta_vda, num_loj, num_pdv, num_cup, ope);
CREATE INDEX idx_ctr_env_xml_cup_nfc_dta_vda ON ctr_env_xml_cup_nfc (dta_vda);
CREATE INDEX idx_ctr_env_xml_cup_nfc_num_loj ON ctr_env_xml_cup_nfc (num_loj);
CREATE INDEX idx_ctr_env_xml_cup_nfc_num_pdv ON ctr_env_xml_cup_nfc (num_pdv);
CREATE INDEX idx_ctr_env_xml_cup_nfc_num_cup ON ctr_env_xml_cup_nfc (num_cup);
CREATE INDEX idx_ctr_env_xml_cup_nfc_ope ON ctr_env_xml_cup_nfc (ope);

CREATE INDEX idx_mov_cup_nfc_num_lot ON mov_cup_nfc (num_lot);
CREATE INDEX idx_mov_cup_nfc_num_ptc ON mov_cup_nfc (num_ptc);
CREATE INDEX idx_mov_cup_nfc_num_rcb ON mov_cup_nfc (num_rcb);
CREATE INDEX idx_mov_cup_nfc_cod_sfz ON mov_cup_nfc (cod_sfz);
CREATE INDEX idx_mov_cup_nfc_tip_ems ON mov_cup_nfc (tip_ems); 

CREATE INDEX idx_ctr_env_nfc_num_lot ON ctr_env_nfc (num_lot);
CREATE INDEX idx_ctr_env_nfc_cod_sfz ON ctr_env_nfc (cod_sfz);
CREATE INDEX idx_ctr_env_nfc_tip_ems ON ctr_env_nfc (tip_ems); 
CREATE INDEX idx_ctr_env_nfc_sit_env_nfc ON ctr_env_nfc (sit_env_nfc);

CREATE INDEX index_detalhe_cup_vnd_loj ON detalhe_cupom_venda (numero_loja);
CREATE INDEX index_detalhe_cup_vnd_ean ON detalhe_cupom_venda (codigo_ean);
CREATE INDEX index_detalhe_cup_vnd_dat ON detalhe_cupom_venda (data_venda);
CREATE INDEX index_detalhe_cup_vnd_cod_prd ON detalhe_cupom_venda (codigo_produto);
CREATE INDEX index_movimento_fin_cod_fin ON movimento_finalizadora (data_movimento,numero_loja,numero_pdv,tipo_movimento,numero_cupom,codigo_finalizadora);
CREATE INDEX index_capa_cup_vda_sit_cap ON capa_cupom_venda (data_venda, total_liquido, situacao_capa);
CREATE INDEX index_capa_cup_vda_dat_loj_pdv ON capa_cupom_venda (data_venda, numero_loja, numero_pdv);
CREATE INDEX index_capa_cup_vda_dat_loj_pdv_cup ON capa_cupom_venda (data_venda, numero_loja, numero_pdv, numero_cupom);
CREATE INDEX index_capa_cup_vda_loj_pdv ON capa_cupom_venda (numero_loja, numero_pdv);
CREATE INDEX index_mov_trn_est_dat_trn_loj_srv ON mov_trn_est (dat_hor_trn, num_loj, id_srv);


GRANT ALL PRIVILEGES ON concentrador.* TO 'econect'@'%' IDENTIFIED BY '123456' WITH GRANT OPTION;
